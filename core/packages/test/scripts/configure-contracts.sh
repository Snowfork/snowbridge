...
configure_contracts()
{
    ...
    cast send $(address_for BeefyClient) \
      ...
      $beefy_start_block \($current_id,$current_length,$current_root\) \($next_id,$next_length,$next_root\) || true # "|| true" can be removed once https://github.com/foundry-rs/foundry/pull/4010 has been released
