...
contract GatewayTest is Test {
    ...
    function testShouldNotSendOperatorsDataBecauseValidatorsNotMultipleOf32() public {
        // Create mock agent and paraID
        ParaID paraID = ParaID.wrap(1);
        bytes32 agentID = keccak256("1");
    ...
    function testShouldNotSendOperatorsDataBecauseValidatorsTooLong() public {
        // Create mock agent and paraID
        ParaID paraID = ParaID.wrap(1);
        bytes32 agentID = keccak256("1");
        ...
        IGateway(address(gateway)).sendOperatorsData{value: 1 ether}(longValidatorsData, paraID);
    }
}
