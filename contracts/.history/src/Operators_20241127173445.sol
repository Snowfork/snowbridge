...
library Operators {
    ...
    function encodeOperatorsData(bytes calldata validatorsKeys, ParaID dest) internal returns (Ticket memory ticket) {
        ...
        ticket.payload = SubstrateTypes.EncodedOperatorsData(validatorsKeys, uint32(validatorsKeysLength));
