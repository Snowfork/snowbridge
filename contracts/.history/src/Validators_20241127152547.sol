...
library Validators {
    ...
    function encodeValidatorsData(bytes calldata data) internal returns (Ticket memory ticket) {
        uint256 validatorsKeysLength = data.length;
        ...
        ticket.payload = SubstrateTypes.EncodedValidatorsData(data, uint32(validatorsKeysLength / 32));
