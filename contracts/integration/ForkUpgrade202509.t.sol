...
contract ForkUpgradeTest is Test {
    ...
    function setUp23432697() public {
        ...
        assertEq(unwrap(exchangeRate), 2_288_329_519_450_801);
        ...
        Gateway202509 newLogic = new Gateway202509(BEEFY_CLIENT, address(new AgentExecutor()));
        ...
        (UD60x18 exchangeRateAfter, uint128 deliveryCostAfter) =
            IGatewayV1(GATEWAY_PROXY).pricingParameters();
    ...
    function testUpgradedGatewayStillAcceptsMintDOT() public {
        ...
        SubmitMessageFixture memory fixture = ForkTestFixtures.makeSubmitMessageFixture(
            "/test/data/mainnet-gateway-submitv1-mint-dot.json"
        );
    ...
    function testUpgradedGatewayStillAcceptsUnlockNativeEther() public {
        setUp23526799();
        SubmitMessageFixture memory fixture = ForkTestFixtures.makeSubmitMessageFixture(
            "/test/data/mainnet-gateway-submitv1-unlock-ether.json"
        );
    ...
    function testUpgradedGatewayStillAcceptsUnlockWEth() public {
        ...
        SubmitMessageFixture memory fixture = ForkTestFixtures.makeSubmitMessageFixture(
            "/test/data/mainnet-gateway-submitv1-unlock-weth.json"
        );
