...
contract BeefyClientTest is Test {
    ...
    function testMinSignatures() public {
        assertEq(27, beefyClient.signatureSamples_public(setSize, 0), "dynamicSignatures incorrect.");
        assertEq(28, beefyClient.signatureSamples_public(setSize, 1), "dynamicSignatures incorrect.");
        assertEq(30, beefyClient.signatureSamples_public(setSize, 2), "dynamicSignatures incorrect.");
        assertEq(32, beefyClient.signatureSamples_public(setSize, 3), "dynamicSignatures incorrect.");
        assertEq(32, beefyClient.signatureSamples_public(setSize, 4), "dynamicSignatures incorrect.");
        assertEq(34, beefyClient.signatureSamples_public(setSize, 5), "dynamicSignatures incorrect.");
        assertEq(34, beefyClient.signatureSamples_public(setSize, 6), "dynamicSignatures incorrect.");
        assertEq(34, beefyClient.signatureSamples_public(setSize, 8), "dynamicSignatures incorrect.");
        assertEq(36, beefyClient.signatureSamples_public(setSize, 9), "dynamicSignatures incorrect.");
        assertEq(36, beefyClient.signatureSamples_public(setSize, 12), "dynamicSignatures incorrect.");
        assertEq(36, beefyClient.signatureSamples_public(setSize, 16), "dynamicSignatures incorrect.");
        assertEq(38, beefyClient.signatureSamples_public(setSize, 17), "dynamicSignatures incorrect.");
        assertEq(38, beefyClient.signatureSamples_public(setSize, 24), "dynamicSignatures incorrect.");
        assertEq(38, beefyClient.signatureSamples_public(setSize, 32), "dynamicSignatures incorrect.");
        assertEq(40, beefyClient.signatureSamples_public(setSize, 33), "dynamicSignatures incorrect.");
        assertEq(40, beefyClient.signatureSamples_public(setSize, 48), "dynamicSignatures incorrect.");
        assertEq(40, beefyClient.signatureSamples_public(setSize, 64), "dynamicSignatures incorrect.");
        assertEq(42, beefyClient.signatureSamples_public(setSize, 65), "dynamicSignatures incorrect.");
        assertEq(42, beefyClient.signatureSamples_public(setSize, 96), "dynamicSignatures incorrect.");
        assertEq(42, beefyClient.signatureSamples_public(setSize, 128), "dynamicSignatures incorrect.");
        assertEq(44, beefyClient.signatureSamples_public(setSize, 129), "dynamicSignatures incorrect.");
        assertEq(44, beefyClient.signatureSamples_public(setSize, 192), "dynamicSignatures incorrect.");
        assertEq(44, beefyClient.signatureSamples_public(setSize, 256), "dynamicSignatures incorrect.");
        assertEq(46, beefyClient.signatureSamples_public(setSize, 257), "dynamicSignatures incorrect.");
        assertEq(46, beefyClient.signatureSamples_public(setSize, 384), "dynamicSignatures incorrect.");
        assertEq(46, beefyClient.signatureSamples_public(setSize, 512), "dynamicSignatures incorrect.");
        assertEq(48, beefyClient.signatureSamples_public(setSize, 513), "dynamicSignatures incorrect.");
        assertEq(48, beefyClient.signatureSamples_public(setSize, 768), "dynamicSignatures incorrect.");
        assertEq(48, beefyClient.signatureSamples_public(setSize, 1024), "dynamicSignatures incorrect.");
        assertEq(50, beefyClient.signatureSamples_public(setSize, 1025), "dynamicSignatures incorrect.");
        assertEq(50, beefyClient.signatureSamples_public(setSize, 1536), "dynamicSignatures incorrect.");
        assertEq(50, beefyClient.signatureSamples_public(setSize, 2048), "dynamicSignatures incorrect.");
        assertEq(52, beefyClient.signatureSamples_public(setSize, 2049), "dynamicSignatures incorrect.");
        assertEq(52, beefyClient.signatureSamples_public(setSize, 3072), "dynamicSignatures incorrect.");
        assertEq(52, beefyClient.signatureSamples_public(setSize, 4096), "dynamicSignatures incorrect.");
        assertEq(54, beefyClient.signatureSamples_public(setSize, 4097), "dynamicSignatures incorrect.");
        assertEq(54, beefyClient.signatureSamples_public(setSize, 6144), "dynamicSignatures incorrect.");
        assertEq(54, beefyClient.signatureSamples_public(setSize, 8192), "dynamicSignatures incorrect.");
        assertEq(56, beefyClient.signatureSamples_public(setSize, 8193), "dynamicSignatures incorrect.");
        assertEq(56, beefyClient.signatureSamples_public(setSize, 12288), "dynamicSignatures incorrect.");
        assertEq(56, beefyClient.signatureSamples_public(setSize, 16384), "dynamicSignatures incorrect.");
        assertEq(58, beefyClient.signatureSamples_public(setSize, 16385), "dynamicSignatures incorrect.");
        assertEq(58, beefyClient.signatureSamples_public(setSize, 24576), "dynamicSignatures incorrect.");
        assertEq(58, beefyClient.signatureSamples_public(setSize, 32768), "dynamicSignatures incorrect.");
        assertEq(60, beefyClient.signatureSamples_public(setSize, 32769), "dynamicSignatures incorrect.");
        assertEq(60, beefyClient.signatureSamples_public(setSize, 49152), "dynamicSignatures incorrect.");
        assertEq(60, beefyClient.signatureSamples_public(setSize, 65535), "dynamicSignatures incorrect.");
    }
}
