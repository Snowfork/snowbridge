...
import {ParachainVerification, VerificationWrapper} from "./mocks/VerificationWrapper.sol";
...
contract VerificationTest is Test {
    ...
    function testCreateParachainHeaderMerkleLeaf() public {
        ParachainVerification.DigestItem[] memory digestItems = new ParachainVerification.DigestItem[](3);
        digestItems[0] =
            ParachainVerification.DigestItem({kind: 6, consensusEngineID: 0x61757261, data: hex"c1f05e0800000000"});
        digestItems[1] = ParachainVerification.DigestItem({
            kind: 4,
            consensusEngineID: 0x52505352,
            data: hex"73a902d5a4fa8fea942d01ad3c1dc32b51192c3a98c39fcc59299006ed391a5e2e005501"
        });
        digestItems[2] = ParachainVerification.DigestItem({
            kind: 5,
        ...
        ParachainVerification.ParachainHeader memory header = ParachainVerification.ParachainHeader({
    ...
    function testCreateParachainHeaderMerkleFailInvalidHeader() public {
        ParachainVerification.DigestItem[] memory digestItems = new ParachainVerification.DigestItem[](1);
        // Create an invalid digest item
        digestItems[0] =
            ParachainVerification.DigestItem({kind: 666, consensusEngineID: 0x61757261, data: hex"c1f05e0800000000"});
        ...
        vm.expectRevert(ParachainVerification.InvalidParachainHeader.selector);
        v.createParachainHeaderMerkleLeaf(encodedParachainID, header);
    }

    function testIsCommitmentInHeaderDigest() public view {
        ParachainVerification.DigestItem[] memory digestItems = new ParachainVerification.DigestItem[](4);
        digestItems[0] =
            ParachainVerification.DigestItem({kind: 6, consensusEngineID: 0x61757261, data: hex"c1f05e0800000000"});
        digestItems[1] = ParachainVerification.DigestItem({
            kind: 4,
        ...
        digestItems[3] = ParachainVerification.DigestItem({
            kind: 5,
            consensusEngineID: 0x61757261,
            data: hex"fcfbfaf1ad15d24cb4980436c18aec6211e2255f648df0e05e73a7858fba8c31726925f1a825383d0d3cb590502b18978101a6391fbeef5ab53e14c05124188c"
        });
