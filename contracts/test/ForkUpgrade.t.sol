...
contract ForkUpgradeTest is Test {
    ...
    bytes32 private constant BridgeHubAgent =
        0x03170a2e7597b7b7e3d84c05391d139a62b157e78786d8c082f29dcf4c111314;

    function setUp() public {
        vm.createSelectFork(
            "https://rpc.tenderly.co/fork/b77e07b8-ad6d-4e83-b5be-30a2001964aa", 20_645_700
        );
    ...
    function forkUpgrade() public {
        ...
        Gateway202410 newLogic = new Gateway202410(
            BeefyClient, address(executor), ParaID.wrap(1002), BridgeHubAgent, 10, 20_000_000_000
        );
    ...
    function checkLegacyToken() public {
        assert(
            IGateway(GatewayProxy).isTokenRegistered(0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2)
        );
        assertEq(
            IGateway(GatewayProxy).queryForeignTokenID(0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2),
            bytes32("")
        );
        assert(
            IGateway(GatewayProxy).isTokenRegistered(0xBA41Ddf06B7fFD89D1267b5A93BFeF2424eb2003)
        );
        assertEq(
            IGateway(GatewayProxy).queryForeignTokenID(0xBA41Ddf06B7fFD89D1267b5A93BFeF2424eb2003),
            bytes32("")
        );
    }
    ...
    function registerForeignToken() public {
        ...
        assert(
            IGateway(GatewayProxy).isTokenRegistered(0x70D9d338A6b17957B16836a90192BD8CDAe0b53d)
        );
        assertEq(
            IGateway(GatewayProxy).queryForeignTokenID(0x70D9d338A6b17957B16836a90192BD8CDAe0b53d),
            dotId
        );
    }
