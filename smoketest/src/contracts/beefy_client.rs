...
pub mod beefy_client {
    ...
    impl ::ethers::core::abi::AbiDecode for BeefyClientErrors {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers::core::abi::AbiEncode for BeefyClientErrors {
    ...
    impl ::core::fmt::Display for BeefyClientErrors {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<InvalidBitfield> for BeefyClientErrors {
        fn from(value: InvalidBitfield) -> Self {
            Self::InvalidBitfield(value)
        }
    }
    impl ::core::convert::From<InvalidCommitment> for BeefyClientErrors {
        fn from(value: InvalidCommitment) -> Self {
            Self::InvalidCommitment(value)
        }
    }
    impl ::core::convert::From<InvalidMMRLeaf> for BeefyClientErrors {
        fn from(value: InvalidMMRLeaf) -> Self {
            Self::InvalidMMRLeaf(value)
        }
    }
    impl ::core::convert::From<InvalidMMRLeafProof> for BeefyClientErrors {
        fn from(value: InvalidMMRLeafProof) -> Self {
            Self::InvalidMMRLeafProof(value)
        }
    }
    impl ::core::convert::From<InvalidSignature> for BeefyClientErrors {
        fn from(value: InvalidSignature) -> Self {
            Self::InvalidSignature(value)
        }
    }
    impl ::core::convert::From<InvalidTask> for BeefyClientErrors {
        fn from(value: InvalidTask) -> Self {
            Self::InvalidTask(value)
        }
    }
    impl ::core::convert::From<InvalidValidatorProof> for BeefyClientErrors {
        fn from(value: InvalidValidatorProof) -> Self {
            Self::InvalidValidatorProof(value)
        }
    }
    impl ::core::convert::From<NotEnoughClaims> for BeefyClientErrors {
        fn from(value: NotEnoughClaims) -> Self {
            Self::NotEnoughClaims(value)
        }
    }
    impl ::core::convert::From<PrevRandaoAlreadyCaptured> for BeefyClientErrors {
        fn from(value: PrevRandaoAlreadyCaptured) -> Self {
            Self::PrevRandaoAlreadyCaptured(value)
        }
    }
    impl ::core::convert::From<PrevRandaoNotCaptured> for BeefyClientErrors {
        fn from(value: PrevRandaoNotCaptured) -> Self {
            Self::PrevRandaoNotCaptured(value)
        }
    }
    impl ::core::convert::From<StaleCommitment> for BeefyClientErrors {
        fn from(value: StaleCommitment) -> Self {
            Self::StaleCommitment(value)
        }
    }
    impl ::core::convert::From<TaskExpired> for BeefyClientErrors {
        fn from(value: TaskExpired) -> Self {
            Self::TaskExpired(value)
        }
    }
    impl ::core::convert::From<WaitPeriodNotOver> for BeefyClientErrors {
    ...
    #[derive(Clone, ::ethers::contract::EthAbiType, Debug, PartialEq, Eq, Hash)]
    pub enum BeefyClientEvents {
        NewMMRRootFilter(NewMMRRootFilter),
        OwnershipTransferredFilter(OwnershipTransferredFilter),
    }
    impl ::ethers::contract::EthLogDecode for BeefyClientEvents {
        fn decode_log(
            log: &::ethers::core::abi::RawLog,
        ) -> ::core::result::Result<Self, ::ethers::core::abi::Error> {
            if let Ok(decoded) = NewMMRRootFilter::decode_log(log) {
                return Ok(BeefyClientEvents::NewMMRRootFilter(decoded));
            }
            if let Ok(decoded) = OwnershipTransferredFilter::decode_log(log) {
                return Ok(BeefyClientEvents::OwnershipTransferredFilter(decoded));
            }
            Err(::ethers::core::abi::Error::InvalidData)
        }
    }
    impl ::core::fmt::Display for BeefyClientEvents {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<NewMMRRootFilter> for BeefyClientEvents {
        fn from(value: NewMMRRootFilter) -> Self {
            Self::NewMMRRootFilter(value)
        }
    }
    impl ::core::convert::From<OwnershipTransferredFilter> for BeefyClientEvents {
    ...
    impl ::ethers::core::abi::AbiDecode for BeefyClientCalls {
        fn decode(
            data: impl AsRef<[u8]>,
        ) -> ::core::result::Result<Self, ::ethers::core::abi::AbiError> {
            let data = data.as_ref();
    ...
    impl ::ethers::core::abi::AbiEncode for BeefyClientCalls {
    ...
    impl ::core::fmt::Display for BeefyClientCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<CommitPrevRandaoCall> for BeefyClientCalls {
        fn from(value: CommitPrevRandaoCall) -> Self {
            Self::CommitPrevRandao(value)
        }
    }
    impl ::core::convert::From<CreateFinalBitfieldCall> for BeefyClientCalls {
        fn from(value: CreateFinalBitfieldCall) -> Self {
            Self::CreateFinalBitfield(value)
        }
    }
    impl ::core::convert::From<CreateInitialBitfieldCall> for BeefyClientCalls {
        fn from(value: CreateInitialBitfieldCall) -> Self {
            Self::CreateInitialBitfield(value)
        }
    }
    impl ::core::convert::From<CurrentValidatorSetCall> for BeefyClientCalls {
        fn from(value: CurrentValidatorSetCall) -> Self {
            Self::CurrentValidatorSet(value)
        }
    }
    impl ::core::convert::From<InitializeCall> for BeefyClientCalls {
        fn from(value: InitializeCall) -> Self {
            Self::Initialize(value)
        }
    }
    impl ::core::convert::From<LatestBeefyBlockCall> for BeefyClientCalls {
        fn from(value: LatestBeefyBlockCall) -> Self {
            Self::LatestBeefyBlock(value)
        }
    }
    impl ::core::convert::From<LatestMMRRootCall> for BeefyClientCalls {
        fn from(value: LatestMMRRootCall) -> Self {
            Self::LatestMMRRoot(value)
        }
    }
    impl ::core::convert::From<NextValidatorSetCall> for BeefyClientCalls {
        fn from(value: NextValidatorSetCall) -> Self {
            Self::NextValidatorSet(value)
        }
    }
    impl ::core::convert::From<OwnerCall> for BeefyClientCalls {
        fn from(value: OwnerCall) -> Self {
            Self::Owner(value)
        }
    }
    impl ::core::convert::From<RandaoCommitDelayCall> for BeefyClientCalls {
        fn from(value: RandaoCommitDelayCall) -> Self {
            Self::RandaoCommitDelay(value)
        }
    }
    impl ::core::convert::From<RandaoCommitExpirationCall> for BeefyClientCalls {
        fn from(value: RandaoCommitExpirationCall) -> Self {
            Self::RandaoCommitExpiration(value)
        }
    }
    impl ::core::convert::From<RenounceOwnershipCall> for BeefyClientCalls {
        fn from(value: RenounceOwnershipCall) -> Self {
            Self::RenounceOwnership(value)
        }
    }
    impl ::core::convert::From<SubmitFinalCall> for BeefyClientCalls {
        fn from(value: SubmitFinalCall) -> Self {
            Self::SubmitFinal(value)
        }
    }
    impl ::core::convert::From<SubmitFinalWithHandoverCall> for BeefyClientCalls {
        fn from(value: SubmitFinalWithHandoverCall) -> Self {
            Self::SubmitFinalWithHandover(value)
        }
    }
    impl ::core::convert::From<SubmitInitialCall> for BeefyClientCalls {
        fn from(value: SubmitInitialCall) -> Self {
            Self::SubmitInitial(value)
        }
    }
    impl ::core::convert::From<SubmitInitialWithHandoverCall> for BeefyClientCalls {
        fn from(value: SubmitInitialWithHandoverCall) -> Self {
            Self::SubmitInitialWithHandover(value)
        }
    }
    impl ::core::convert::From<TasksCall> for BeefyClientCalls {
        fn from(value: TasksCall) -> Self {
            Self::Tasks(value)
        }
    }
    impl ::core::convert::From<TransferOwnershipCall> for BeefyClientCalls {
        fn from(value: TransferOwnershipCall) -> Self {
            Self::TransferOwnership(value)
        }
    }
    impl ::core::convert::From<VerifyMMRLeafProofCall> for BeefyClientCalls {
