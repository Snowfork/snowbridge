...
pub mod recipient_mock {
    ...
    impl<M: ::ethers::providers::Middleware> RecipientMock<M> {
        ...
        pub fn handle(
            ...
            self.0
                .method_hash([187, 201, 250, 192], (p0, p1))
    ...
    pub struct HandleCall(pub u32, pub ::ethers::core::types::Bytes);
