...
declare module '@polkadot/types/lookup' {
  ...
  import type { AccountId32, Call, H128, H160, H256, H512, MultiAddress, Perbill } from '@polkadot/types/interfaces/runtime';
  ...
  /** @name SnowbridgeBasicChannelInboundPalletEvent (41) */
  export type SnowbridgeBasicChannelInboundPalletEvent = Null;

  /** @name SnowbridgeBasicChannelOutboundPalletEvent (42) */
  export interface SnowbridgeBasicChannelOutboundPalletEvent extends Enum {
    readonly isMessageAccepted: boolean;
    readonly asMessageAccepted: u64;
    readonly type: 'MessageAccepted';
  }

  /** @name SnowbridgeIncentivizedChannelInboundPalletEvent (43) */
  export type SnowbridgeIncentivizedChannelInboundPalletEvent = Null;

  /** @name SnowbridgeIncentivizedChannelOutboundPalletEvent (44) */
  export interface SnowbridgeIncentivizedChannelOutboundPalletEvent extends Enum {
    readonly isMessageAccepted: boolean;
    readonly asMessageAccepted: u64;
    readonly type: 'MessageAccepted';
  }

  /** @name SnowbridgeDispatchEvent (45) */
  export interface SnowbridgeDispatchEvent extends Enum {
  ...
  /** @name SnowbridgeCoreMessageId (46) */
  export interface SnowbridgeCoreMessageId extends Struct {
    readonly channelId: SnowbridgeCoreChannelId;
    readonly nonce: u64;
  }

  /** @name SnowbridgeCoreChannelId (47) */
  export interface SnowbridgeCoreChannelId extends Enum {
    readonly isBasic: boolean;
    readonly isIncentivized: boolean;
    readonly type: 'Basic' | 'Incentivized';
  }

  /** @name SnowbridgeEthereumLightClientEvent (48) */
  export type SnowbridgeEthereumLightClientEvent = Null;
  ...
  /** @name PalletCollatorSelectionEvent (95) */
  ...
  /** @name SnowbridgeDotAppEvent (100) */
  export interface SnowbridgeDotAppEvent extends Enum {
  ...
  /** @name SnowbridgeEthAppEvent (102) */
  export interface SnowbridgeEthAppEvent extends Enum {
    readonly isBurned: boolean;
  ...
  /** @name SnowbridgeErc20AppEvent (103) */
  export interface SnowbridgeErc20AppEvent extends Enum {
    readonly isBurned: boolean;
  ...
  /** @name PalletBalancesReleases (135) */
  ...
  /** @name PalletTransactionPaymentReleases (141) */
  ...
  /** @name FrameSupportWeightsWeightToFeeCoefficient (143) */
  ...
  /** @name FrameSupportScheduleMaybeHashed (150) */
  ...
  /** @name PolkadotPrimitivesV2PersistedValidationData (154) */
  ...
  /** @name SnowbridgeBasicChannelInboundPalletCall (167) */
  export interface SnowbridgeBasicChannelInboundPalletCall extends Enum {
  ...
  /** @name SnowbridgeCoreMessage (168) */
  export interface SnowbridgeCoreMessage extends Struct {
    readonly data: Bytes;
    readonly proof: SnowbridgeCoreProof;
  }

  /** @name SnowbridgeCoreProof (169) */
  export interface SnowbridgeCoreProof extends Struct {
    readonly blockHash: H256;
    readonly txIndex: u32;
    readonly data: ITuple<[Vec<Bytes>, Vec<Bytes>]>;
  }

  /** @name SnowbridgeBasicChannelOutboundPalletCall (171) */
  export interface SnowbridgeBasicChannelOutboundPalletCall extends Enum {
    readonly isSetPrincipal: boolean;
    readonly asSetPrincipal: {
      readonly principal: MultiAddress;
    } & Struct;
    readonly type: 'SetPrincipal';
  }

  /** @name SnowbridgeIncentivizedChannelInboundPalletCall (172) */
  export interface SnowbridgeIncentivizedChannelInboundPalletCall extends Enum {
    readonly isSubmit: boolean;
    readonly asSubmit: {
      readonly message: SnowbridgeCoreMessage;
    } & Struct;
  ...
  /** @name SnowbridgeIncentivizedChannelOutboundPalletCall (173) */
  export interface SnowbridgeIncentivizedChannelOutboundPalletCall extends Enum {
  ...
  /** @name SnowbridgeDispatchCall (174) */
  export type SnowbridgeDispatchCall = Null;

  /** @name SnowbridgeEthereumLightClientCall (175) */
  export interface SnowbridgeEthereumLightClientCall extends Enum {
    readonly isImportHeader: boolean;
    readonly asImportHeader: {
      readonly header: SnowbridgeEthereumHeader;
      readonly proof: Vec<SnowbridgeEthereumEthashproofDoubleNodeWithMerkleProof>;
    } & Struct;
    readonly isForceResetToFork: boolean;
    readonly asForceResetToFork: {
      readonly forkedAt: H256;
    } & Struct;
    readonly type: 'ImportHeader' | 'ForceResetToFork';
  }

  /** @name SnowbridgeEthereumHeader (176) */
  export interface SnowbridgeEthereumHeader extends Struct {
    ...
    readonly logsBloom: SnowbridgeEthereumHeaderBloom;
  ...
  /** @name SnowbridgeEthereumHeaderBloom (177) */
  export interface SnowbridgeEthereumHeaderBloom extends U8aFixed {}

  /** @name SnowbridgeEthereumEthashproofDoubleNodeWithMerkleProof (183) */
  export interface SnowbridgeEthereumEthashproofDoubleNodeWithMerkleProof extends Struct {
    readonly dagNodes: Vec<H512>;
    readonly proof: Vec<H128>;
  }

  /** @name PalletAssetsCall (189) */
  ...
  /** @name PalletAssetsDestroyWitness (190) */
  ...
  /** @name CumulusPalletXcmpQueueCall (191) */
  ...
  /** @name PalletCollatorSelectionCall (223) */
  ...
  /** @name SnowbaseRuntimeSessionKeys (225) */
  export interface SnowbaseRuntimeSessionKeys extends Struct {
    readonly aura: SpConsensusAuraSr25519AppSr25519Public;
  }

  /** @name SpConsensusAuraSr25519AppSr25519Public (226) */
  export interface SpConsensusAuraSr25519AppSr25519Public extends SpCoreSr25519Public {}

  /** @name SpCoreSr25519Public (227) */
  ...
  /** @name SnowbridgeDotAppCall (229) */
  export interface SnowbridgeDotAppCall extends Enum {
  ...
  /** @name SnowbridgeEthAppCall (230) */
  export interface SnowbridgeEthAppCall extends Enum {
    readonly isBurn: boolean;
    readonly asBurn: {
      readonly channelId: SnowbridgeCoreChannelId;
      readonly recipient: H160;
    ...
    readonly asMint: {
      ...
      readonly recipient: MultiAddress;
      readonly amount: u128;
      readonly destination: Option<SnowbridgeCoreAssetsRemoteParachain>;
    } & Struct;
    readonly type: 'Burn' | 'Mint';
  }

  /** @name SnowbridgeCoreAssetsRemoteParachain (232) */
  export interface SnowbridgeCoreAssetsRemoteParachain extends Struct {
    readonly paraId: u32;
    readonly fee: u128;
  }

  /** @name SnowbridgeErc20AppCall (233) */
  export interface SnowbridgeErc20AppCall extends Enum {
    readonly isBurn: boolean;
    readonly asBurn: {
      readonly channelId: SnowbridgeCoreChannelId;
      readonly token: H160;
  ...
  /** @name SnowbaseRuntimeOriginCaller (234) */
  export interface SnowbaseRuntimeOriginCaller extends Enum {
  ...
  /** @name CumulusPalletXcmOrigin (239) */
  ...
  /** @name PalletUtilityError (241) */
  export interface PalletUtilityError extends Enum {
    readonly isTooManyCalls: boolean;
    readonly type: 'TooManyCalls';
  }

  /** @name PalletSchedulerScheduledV3 (244) */
  ...
  /** @name PalletPreimageRequestStatus (246) */
  ...
  /** @name PolkadotPrimitivesV2UpgradeRestriction (252) */
  export interface PolkadotPrimitivesV2UpgradeRestriction extends Enum {
    readonly isPresent: boolean;
    readonly type: 'Present';
  }

  /** @name CumulusPalletParachainSystemRelayStateSnapshotMessagingStateSnapshot (253) */
  ...
  /** @name PolkadotPrimitivesV2AbridgedHrmpChannel (256) */
  ...
  /** @name PolkadotPrimitivesV2AbridgedHostConfiguration (257) */
  ...
  /** @name PolkadotCorePrimitivesOutboundHrmpMessage (263) */
  export interface PolkadotCorePrimitivesOutboundHrmpMessage extends Struct {
    readonly recipient: u32;
    readonly data: Bytes;
  }

  /** @name CumulusPalletParachainSystemError (264) */
  ...
  /** @name PalletCollectiveVotes (266) */
  ...
  /** @name PalletCollectiveError (267) */
  ...
  /** @name PalletMembershipError (268) */
  ...
  /** @name SnowbridgeBasicChannelInboundPalletError (269) */
  export interface SnowbridgeBasicChannelInboundPalletError extends Enum {
  ...
  /** @name SnowbridgeBasicChannelOutboundMessage (271) */
  export interface SnowbridgeBasicChannelOutboundMessage extends Struct {
    readonly id: u64;
    readonly target: H160;
    readonly payload: Bytes;
  }

  /** @name SnowbridgeBasicChannelOutboundPalletError (273) */
  export interface SnowbridgeBasicChannelOutboundPalletError extends Enum {
    readonly isPayloadTooLarge: boolean;
    readonly isQueueSizeLimitReached: boolean;
    readonly isOverflow: boolean;
    readonly isNotAuthorized: boolean;
    readonly type: 'PayloadTooLarge' | 'QueueSizeLimitReached' | 'Overflow' | 'NotAuthorized';
  }

  /** @name SnowbridgeIncentivizedChannelInboundPalletError (274) */
  export interface SnowbridgeIncentivizedChannelInboundPalletError extends Enum {
    readonly isInvalidSourceChannel: boolean;
    readonly isInvalidEnvelope: boolean;
    readonly isInvalidNonce: boolean;
    readonly type: 'InvalidSourceChannel' | 'InvalidEnvelope' | 'InvalidNonce';
  ...
  /** @name SnowbridgeIncentivizedChannelOutboundMessage (276) */
  export interface SnowbridgeIncentivizedChannelOutboundMessage extends Struct {
    readonly id: u64;
    readonly target: H160;
    readonly fee: u128;
    readonly payload: Bytes;
  ...
  /** @name SnowbridgeIncentivizedChannelOutboundPalletError (277) */
  export interface SnowbridgeIncentivizedChannelOutboundPalletError extends Enum {
    readonly isPayloadTooLarge: boolean;
    readonly isQueueSizeLimitReached: boolean;
    readonly isNoFunds: boolean;
    readonly isOverflow: boolean;
  ...
  /** @name SnowbridgeEthereumHeaderHeaderId (279) */
  export interface SnowbridgeEthereumHeaderHeaderId extends Struct {
    readonly number: u64;
    readonly hash_: H256;
  }

  /** @name SnowbridgeEthereumLightClientPruningRange (280) */
  export interface SnowbridgeEthereumLightClientPruningRange extends Struct {
    readonly oldestUnprunedBlock: u64;
    readonly oldestBlockToKeep: u64;
  }

  /** @name SnowbridgeEthereumLightClientStoredHeader (281) */
  export interface SnowbridgeEthereumLightClientStoredHeader extends Struct {
  ...
  /** @name SnowbridgeEthereumDifficultyDifficultyConfig (283) */
  export interface SnowbridgeEthereumDifficultyDifficultyConfig extends Struct {
  ...
  /** @name SnowbridgeEthereumLightClientError (284) */
  export interface SnowbridgeEthereumLightClientError extends Enum {
    ...
    readonly isAtMaxHeadersForNumber: boolean;
    readonly isUnknown: boolean;
    readonly type: 'AncientHeader' | 'MissingHeader' | 'MissingParentHeader' | 'DuplicateHeader' | 'HeaderNotFinalized' | 'HeaderOnStaleFork' | 'InvalidHeader' | 'InvalidProof' | 'DecodeFailed' | 'AtMaxHeadersForNumber' | 'Unknown';
  }

  /** @name PalletAssetsAssetDetails (285) */
  ...
  /** @name PalletAssetsAssetAccount (287) */
  ...
  /** @name PalletAssetsExistenceReason (288) */
  ...
  /** @name PalletAssetsApproval (290) */
  export interface PalletAssetsApproval extends Struct {
    readonly amount: u128;
    readonly deposit: u128;
  }

  /** @name PalletAssetsAssetMetadata (291) */
  ...
  /** @name SnowbridgeAssetRegistryError (294) */
  export type SnowbridgeAssetRegistryError = Null;

  /** @name CumulusPalletXcmpQueueInboundChannelDetails (296) */
  ...
  /** @name CumulusPalletXcmpQueueInboundState (297) */
  ...
  /** @name PolkadotParachainPrimitivesXcmpMessageFormat (300) */
  ...
  /** @name CumulusPalletXcmpQueueOutboundChannelDetails (303) */
  ...
  /** @name CumulusPalletXcmpQueueOutboundState (304) */
  ...
  /** @name CumulusPalletXcmpQueueQueueConfigData (306) */
  ...
  /** @name CumulusPalletXcmpQueueError (308) */
  ...
  /** @name CumulusPalletDmpQueueConfigData (309) */
  export interface CumulusPalletDmpQueueConfigData extends Struct {
    readonly maxIndividual: u64;
  }

  /** @name CumulusPalletDmpQueuePageIndexData (310) */
  ...
  /** @name CumulusPalletDmpQueueError (313) */
  ...
  /** @name PalletAuthorshipError (318) */
  ...
  /** @name PalletCollatorSelectionCandidateInfo (320) */
  export interface PalletCollatorSelectionCandidateInfo extends Struct {
    readonly who: AccountId32;
    readonly deposit: u128;
  }

  /** @name PalletCollatorSelectionError (321) */
  ...
  /** @name SnowbridgeDotAppError (329) */
  export interface SnowbridgeDotAppError extends Enum {
    readonly isOverflow: boolean;
    readonly type: 'Overflow';
  }

  /** @name SnowbridgeEthAppError (330) */
  export type SnowbridgeEthAppError = Null;

  /** @name SnowbridgeErc20AppError (331) */
  export type SnowbridgeErc20AppError = Null;
  ...
  /** @name SnowbaseRuntimeRuntime (348) */
  export type SnowbaseRuntimeRuntime = Null;
