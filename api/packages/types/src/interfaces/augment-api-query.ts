...
import type { CumulusPalletDmpQueueConfigData, CumulusPalletDmpQueuePageIndexData, CumulusPalletParachainSystemRelayStateSnapshotMessagingStateSnapshot, CumulusPalletXcmpQueueInboundChannelDetails, CumulusPalletXcmpQueueOutboundChannelDetails, CumulusPalletXcmpQueueQueueConfigData, FrameSupportWeightsPerDispatchClassU64, FrameSystemAccountInfo, FrameSystemEventRecord, FrameSystemLastRuntimeUpgradeInfo, FrameSystemPhase, PalletAssetsApproval, PalletAssetsAssetAccount, PalletAssetsAssetDetails, PalletAssetsAssetMetadata, PalletAuthorshipUncleEntryItem, PalletBalancesAccountData, PalletBalancesBalanceLock, PalletBalancesReleases, PalletBalancesReserveData, PalletCollatorSelectionCandidateInfo, PalletCollectiveVotes, PalletPreimageRequestStatus, PalletSchedulerScheduledV3, PalletTransactionPaymentReleases, PolkadotCorePrimitivesOutboundHrmpMessage, PolkadotPrimitivesV2AbridgedHostConfiguration, PolkadotPrimitivesV2PersistedValidationData, PolkadotPrimitivesV2UpgradeRestriction, SnowbaseRuntimeSessionKeys, SnowbridgeBasicChannelOutboundMessage, SnowbridgeEthereumHeaderHeaderId, SnowbridgeEthereumLightClientPruningRange, SnowbridgeEthereumLightClientStoredHeader, SnowbridgeIncentivizedChannelOutboundMessage, SpCoreCryptoKeyTypeId, SpRuntimeDigest, SpTrieStorageProof } from '@polkadot/types/lookup';
import type { Observable } from '@polkadot/types/types';

declare module '@polkadot/api-base/types/storage' {
  export interface AugmentedQueries<ApiType extends ApiTypes> {
    assetRegistry: {
      nextAssetId: AugmentedQuery<ApiType, () => Observable<u128>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Generic query
       **/
    ...
    basicInboundChannel: {
       ...
       **/
      sourceChannel: AugmentedQuery<ApiType, () => Observable<H160>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    basicOutboundChannel: {
       ...
       **/
      interval: AugmentedQuery<ApiType, () => Observable<u32>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Messages waiting to be committed.
       **/
      messageQueue: AugmentedQuery<ApiType, () => Observable<Vec<SnowbridgeBasicChannelOutboundMessage>>, []> & QueryableStorageEntry<ApiType, []>;
      nextId: AugmentedQuery<ApiType, () => Observable<u64>, []> & QueryableStorageEntry<ApiType, []>;
      nonce: AugmentedQuery<ApiType, () => Observable<u64>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Fee for accepting a message
       **/
      principal: AugmentedQuery<ApiType, () => Observable<Option<AccountId32>>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    dotApp: {
      address: AugmentedQuery<ApiType, () => Observable<H160>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    erc20App: {
      address: AugmentedQuery<ApiType, () => Observable<H160>, []> & QueryableStorageEntry<ApiType, []>;
      assetId: AugmentedQuery<ApiType, (arg: H160 | string | Uint8Array) => Observable<Option<u128>>, [H160]> & QueryableStorageEntry<ApiType, [H160]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    ethereumLightClient: {
       ...
       * Best known block.
       **/
      bestBlock: AugmentedQuery<ApiType, () => Observable<ITuple<[SnowbridgeEthereumHeaderHeaderId, U256]>>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Range of blocks that we want to prune.
       **/
      blocksToPrune: AugmentedQuery<ApiType, () => Observable<SnowbridgeEthereumLightClientPruningRange>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Best finalized block.
       **/
      finalizedBlock: AugmentedQuery<ApiType, () => Observable<SnowbridgeEthereumHeaderHeaderId>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Map of imported headers by hash.
       **/
      headers: AugmentedQuery<ApiType, (arg: H256 | string | Uint8Array) => Observable<Option<SnowbridgeEthereumLightClientStoredHeader>>, [H256]> & QueryableStorageEntry<ApiType, [H256]>;
      /**
    ...
    incentivizedInboundChannel: {
       ...
       **/
      rewardFraction: AugmentedQuery<ApiType, () => Observable<Perbill>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Source channel on the ethereum side
       **/
      sourceChannel: AugmentedQuery<ApiType, () => Observable<H160>, []> & QueryableStorageEntry<ApiType, []>;
    ...
    incentivizedOutboundChannel: {
       ...
       * Fee for accepting a message
       **/
      fee: AugmentedQuery<ApiType, () => Observable<u128>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Interval between commitments
       **/
      interval: AugmentedQuery<ApiType, () => Observable<u32>, []> & QueryableStorageEntry<ApiType, []>;
       ...
       * Messages waiting to be committed.
       **/
      messageQueue: AugmentedQuery<ApiType, () => Observable<Vec<SnowbridgeIncentivizedChannelOutboundMessage>>, []> & QueryableStorageEntry<ApiType, []>;
      nextId: AugmentedQuery<ApiType, () => Observable<u64>, []> & QueryableStorageEntry<ApiType, []>;
      nonce: AugmentedQuery<ApiType, () => Observable<u64>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Generic query
    ...
    session: {
       ...
       **/
      nextKeys: AugmentedQuery<ApiType, (arg: AccountId32 | string | Uint8Array) => Observable<Option<SnowbaseRuntimeSessionKeys>>, [AccountId32]> & QueryableStorageEntry<ApiType, [AccountId32]>;
      /**
       ...
       **/
      queuedKeys: AugmentedQuery<ApiType, () => Observable<Vec<ITuple<[AccountId32, SnowbaseRuntimeSessionKeys]>>>, []> & QueryableStorageEntry<ApiType, []>;
      /**
