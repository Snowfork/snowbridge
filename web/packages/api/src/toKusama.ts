...
import {
    ...
    kusamaAssetHubLocation, buildAssetHubERC20TransferToKusamaFromParachain
} from "./xcmBuilder";
...
export function createERC20SourceParachainTxKusama(
    ...
    const customXcm = buildAssetHubERC20TransferToKusamaFromParachain(parachain.registry, sourceAccount, beneficiaryAccount)
