...
build_binaries() {
    ...
    cargo build --release --workspace --bin polkadot --bin polkadot-execute-worker --bin polkadot-prepare-worker --bin parachain-template-node
    ...
    cargo build --release --workspace --bin polkadot-parachain $features
