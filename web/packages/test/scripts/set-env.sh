...
gas_estimator_dir="$root_dir/gas-estimator"
...
beefy_relay_eth_key_2="${BEEFY_RELAY_ETH_KEY_2:-0x27ae0c7b8d7c698e41b173265490a4c64b4e39ae78599166e003f868f12140fd}"
...
## BeefyClientWrapper
export BEEFY_WRAPPER_MAX_GAS_PRICE="${BEEFY_WRAPPER_MAX_GAS_PRICE:-100000000000}"
export BEEFY_WRAPPER_MAX_REFUND_AMOUNT="${BEEFY_WRAPPER_MAX_REFUND_AMOUNT:-1000000000000000000}"
export BEEFY_WRAPPER_REFUND_TARGET="${BEEFY_WRAPPER_REFUND_TARGET:-10}"
export BEEFY_WRAPPER_REWARD_TARGET="${BEEFY_WRAPPER_REWARD_TARGET:-2400}"
export BEEFY_WRAPPER_TICKET_TIMEOUT="${BEEFY_WRAPPER_TICKET_TIMEOUT:-900}"
export BEEFY_WRAPPER_INITIAL_DEPOSIT="${BEEFY_WRAPPER_INITIAL_DEPOSIT:-10000000000000000000}"
# Relayer addresses (derived from private keys)
export BEEFY_RELAY_ETH_ADDRESS_1="${BEEFY_RELAY_ETH_ADDRESS_1:-0x87D987206180B8f3807Dd90455606eEa85cdB87a}"
export BEEFY_RELAY_ETH_ADDRESS_2="${BEEFY_RELAY_ETH_ADDRESS_2:-0xACbd24742b87c34dED607FB87b22401B2Ede167E}"
