...
export async function ethereumL242161ToPolkadot1000Weth(
    api: SnowbridgeApi<EthersEthereumProvider>,
) {
    const sourceAccount = process.env.ETHEREUM_ACCOUNT_PUBLIC
    const beneficiaryAccount = process.env.SUBSTRATE_ACCOUNT_PUBLIC
    if (!sourceAccount) throw new Error("Missing required env var for source account.")
...
export async function polkadot1000ToEthereumL210Eth(api: SnowbridgeApi<EthersEthereumProvider>) {
    const sourceAccount = process.env.SUBSTRATE_ACCOUNT_PUBLIC
    const beneficiaryAccount = process.env.ETHEREUM_ACCOUNT_PUBLIC
    if (!sourceAccount) throw new Error("Missing required env var for source account.")
    if (!beneficiaryAccount) throw new Error("Missing required env var for beneficiary account.")
...
export async function polkadot1000ToEthereumL242161Weth(
    api: SnowbridgeApi<EthersEthereumProvider>,
) {
    const sourceAccount = process.env.SUBSTRATE_ACCOUNT_PUBLIC
    const beneficiaryAccount = process.env.ETHEREUM_ACCOUNT_PUBLIC
...
export async function polkadot1000ToEthereumL28453Usdc(api: SnowbridgeApi<EthersEthereumProvider>) {
    const sourceAccount = process.env.SUBSTRATE_ACCOUNT_PUBLIC
    const beneficiaryAccount = process.env.ETHEREUM_ACCOUNT_PUBLIC
    if (!sourceAccount) throw new Error("Missing required env var for source account.")
    if (!beneficiaryAccount) throw new Error("Missing required env var for beneficiary account.")
...
export async function polkadot1000ToPolkadot2034Usdc(api: SnowbridgeApi<EthersEthereumProvider>) {
    const sourceAccount = process.env.SUBSTRATE_ACCOUNT_PUBLIC
    const beneficiaryAccount = process.env.SUBSTRATE_ACCOUNT_PUBLIC
    if (!sourceAccount) throw new Error("Missing required env var for source account.")
    if (!beneficiaryAccount) throw new Error("Missing required env var for beneficiary account.")
...
export async function polkadot2000ToEth1Eth(api: SnowbridgeApi<EthersEthereumProvider>) {
    const sourceAccount = process.env.SUBSTRATE_ACCOUNT_PUBLIC
    const beneficiaryAccount = process.env.ETHEREUM_ACCOUNT_PUBLIC
    if (!sourceAccount) throw new Error("Missing required env var for source account.")
    if (!beneficiaryAccount) throw new Error("Missing required env var for beneficiary account.")
...
export async function polkadot2004ToEth1Weth(api: SnowbridgeApi<EthersEthereumProvider>) {
    const sourceAccount = process.env.ETHEREUM_ACCOUNT_PUBLIC
    const beneficiaryAccount = process.env.ETHEREUM_ACCOUNT_PUBLIC
    if (!sourceAccount) throw new Error("Missing required env var for source account.")
    if (!beneficiaryAccount) throw new Error("Missing required env var for beneficiary account.")
...
export async function polkadot2030ToEth1Eth(api: SnowbridgeApi<EthersEthereumProvider>) {
    const sourceAccount = process.env.SUBSTRATE_ACCOUNT_PUBLIC
    const beneficiaryAccount = process.env.ETHEREUM_ACCOUNT_PUBLIC
    if (!sourceAccount) throw new Error("Missing required env var for source account.")
    if (!beneficiaryAccount) throw new Error("Missing required env var for beneficiary account.")
...
export async function polkadot2034ToEth1Usdc(api: SnowbridgeApi<EthersEthereumProvider>) {
    const sourceAccount = process.env.SUBSTRATE_ACCOUNT_PUBLIC
    const beneficiaryAccount = process.env.ETHEREUM_ACCOUNT_PUBLIC
    if (!sourceAccount) throw new Error("Missing required env var for source account.")
    if (!beneficiaryAccount) throw new Error("Missing required env var for beneficiary account.")
...
export async function polkadot2034ToPolkadot1000Usdc(api: SnowbridgeApi<EthersEthereumProvider>) {
    const sourceAccount = process.env.SUBSTRATE_ACCOUNT_PUBLIC
    const beneficiaryAccount = process.env.SUBSTRATE_ACCOUNT_PUBLIC
    if (!sourceAccount) throw new Error("Missing required env var for source account.")
    if (!beneficiaryAccount) throw new Error("Missing required env var for beneficiary account.")
...
export async function polkadot2043ToEth1Trac(api: SnowbridgeApi<EthersEthereumProvider>) {
    const sourceAccount = process.env.SUBSTRATE_ACCOUNT_PUBLIC
    const beneficiaryAccount = process.env.ETHEREUM_ACCOUNT_PUBLIC
    if (!sourceAccount) throw new Error("Missing required env var for source account.")
    if (!beneficiaryAccount) throw new Error("Missing required env var for beneficiary account.")
...
export async function polkadot3369ToEth1Myth(api: SnowbridgeApi<EthersEthereumProvider>) {
    const sourceAccount = process.env.ETHEREUM_ACCOUNT_PUBLIC
    const beneficiaryAccount = process.env.ETHEREUM_ACCOUNT_PUBLIC
    if (!sourceAccount) throw new Error("Missing required env var for source account.")
    if (!beneficiaryAccount) throw new Error("Missing required env var for beneficiary account.")
...
export async function createAgent(api: SnowbridgeApi<EthersEthereumProvider>) {
    const sourceAccount = process.env.ETHEREUM_ACCOUNT_PUBLIC
    if (!sourceAccount) throw new Error("Missing required env var for source account.")
    ...
    const validation = await creationImpl.build(sourceAccount, agentId)
...
export async function registerToken(api: SnowbridgeApi<EthersEthereumProvider>) {
    const sourceAccount = process.env.ETHEREUM_ACCOUNT_PUBLIC
    ...
    const validation = await registrationImpl.build(
        sourceAccount,
