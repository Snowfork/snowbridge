...
//
// Solidity: function createCommitmentHash((bytes32,uint64,uint32) commitment) view returns(bytes32)
...
// EncodeMMRLeaf is a free data retrieval call binding the contract method 0x3adcebda.
//
// Solidity: function encodeMMRLeaf((uint32,bytes32,bytes32,uint64,uint32,bytes32) leaf) pure returns(bytes)
...
// VerifyNewestMMRLeaf is a paid mutator transaction binding the contract method 0x4cb3f89d.
//
// Solidity: function verifyNewestMMRLeaf((uint32,bytes32,bytes32,uint64,uint32,bytes32) leaf, bytes32[] proof, bytes32 root, uint64 length) returns()
func (_Contract *ContractTransactor) VerifyNewestMMRLeaf(opts *bind.TransactOpts, leaf BeefyLightClientBeefyMMRLeaf, proof [][32]byte, root [32]byte, length uint64) (*types.Transaction, error) {
	return _Contract.contract.Transact(opts, "verifyNewestMMRLeaf", leaf, proof, root, length)
}

// VerifyNewestMMRLeaf is a paid mutator transaction binding the contract method 0x4cb3f89d.
//
// Solidity: function verifyNewestMMRLeaf((uint32,bytes32,bytes32,uint64,uint32,bytes32) leaf, bytes32[] proof, bytes32 root, uint64 length) returns()
func (_Contract *ContractSession) VerifyNewestMMRLeaf(leaf BeefyLightClientBeefyMMRLeaf, proof [][32]byte, root [32]byte, length uint64) (*types.Transaction, error) {
	return _Contract.Contract.VerifyNewestMMRLeaf(&_Contract.TransactOpts, leaf, proof, root, length)
}

// VerifyNewestMMRLeaf is a paid mutator transaction binding the contract method 0x4cb3f89d.
//
// Solidity: function verifyNewestMMRLeaf((uint32,bytes32,bytes32,uint64,uint32,bytes32) leaf, bytes32[] proof, bytes32 root, uint64 length) returns()
func (_Contract *ContractTransactorSession) VerifyNewestMMRLeaf(leaf BeefyLightClientBeefyMMRLeaf, proof [][32]byte, root [32]byte, length uint64) (*types.Transaction, error) {
	return _Contract.Contract.VerifyNewestMMRLeaf(&_Contract.TransactOpts, leaf, proof, root, length)
}
