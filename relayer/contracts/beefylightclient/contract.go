...
func (_Contract *ContractTransactor) CompleteSignatureCommitment(opts *bind.TransactOpts, id *big.Int, commitment BeefyLightClientCommitment, proof BeefyLightClientValidatorProof) (*types.Transaction, error) {
	return _Contract.contract.Transact(opts, "completeSignatureCommitment", id, commitment, proof)
}

// CompleteSignatureCommitment is a paid mutator transaction binding the contract method 0xebf7f0a0.
//
// Solidity: function completeSignatureCommitment(uint256 id, (uint32,uint64,(bytes32,bytes,bytes)) commitment, (bytes[],uint256[],address[],bytes32[][]) proof) returns()
func (_Contract *ContractSession) CompleteSignatureCommitment(id *big.Int, commitment BeefyLightClientCommitment, proof BeefyLightClientValidatorProof) (*types.Transaction, error) {
	return _Contract.Contract.CompleteSignatureCommitment(&_Contract.TransactOpts, id, commitment, proof)
}

// CompleteSignatureCommitment is a paid mutator transaction binding the contract method 0xebf7f0a0.
//
// Solidity: function completeSignatureCommitment(uint256 id, (uint32,uint64,(bytes32,bytes,bytes)) commitment, (bytes[],uint256[],address[],bytes32[][]) proof) returns()
func (_Contract *ContractTransactorSession) CompleteSignatureCommitment(id *big.Int, commitment BeefyLightClientCommitment, proof BeefyLightClientValidatorProof) (*types.Transaction, error) {
	return _Contract.Contract.CompleteSignatureCommitment(&_Contract.TransactOpts, id, commitment, proof)
}
...
func (_Contract *ContractTransactor) UpdateValidatorSet(opts *bind.TransactOpts, leaf BeefyLightClientMMRLeaf, proof SimplifiedMMRProof) (*types.Transaction, error) {
	return _Contract.contract.Transact(opts, "updateValidatorSet", leaf, proof)
}

// UpdateValidatorSet is a paid mutator transaction binding the contract method 0x9b1a8eaf.
//
// Solidity: function updateValidatorSet((uint8,uint32,bytes32,uint64,uint32,bytes32,bytes32) leaf, (bytes32[],uint64) proof) returns()
func (_Contract *ContractSession) UpdateValidatorSet(leaf BeefyLightClientMMRLeaf, proof SimplifiedMMRProof) (*types.Transaction, error) {
	return _Contract.Contract.UpdateValidatorSet(&_Contract.TransactOpts, leaf, proof)
}

// UpdateValidatorSet is a paid mutator transaction binding the contract method 0x9b1a8eaf.
//
// Solidity: function updateValidatorSet((uint8,uint32,bytes32,uint64,uint32,bytes32,bytes32) leaf, (bytes32[],uint64) proof) returns()
func (_Contract *ContractTransactorSession) UpdateValidatorSet(leaf BeefyLightClientMMRLeaf, proof SimplifiedMMRProof) (*types.Transaction, error) {
	return _Contract.Contract.UpdateValidatorSet(&_Contract.TransactOpts, leaf, proof)
}

// ContractCommitmentVerifiedIterator is returned from FilterCommitmentVerified and is used to iterate over the raw logs and unpacked data for CommitmentVerified events raised by the Contract contract.
type ContractCommitmentVerifiedIterator struct {
	Event *ContractCommitmentVerified // Event containing the contract specifics and raw log
...
func (it *ContractCommitmentVerifiedIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ContractCommitmentVerified)
...
func (it *ContractCommitmentVerifiedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *ContractCommitmentVerifiedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// ContractCommitmentVerified represents a CommitmentVerified event raised by the Contract contract.
type ContractCommitmentVerified struct {
	Id             *big.Int
	Phase          uint8
	CommitmentHash [32]byte
...
func (_Contract *ContractFilterer) FilterCommitmentVerified(opts *bind.FilterOpts) (*ContractCommitmentVerifiedIterator, error) {

	logs, sub, err := _Contract.contract.FilterLogs(opts, "CommitmentVerified")
	if err != nil {
		return nil, err
	}
	return &ContractCommitmentVerifiedIterator{contract: _Contract.contract, event: "CommitmentVerified", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event CommitmentVerified(uint256 id, uint8 phase, bytes32 commitmentHash, address prover)
func (_Contract *ContractFilterer) WatchCommitmentVerified(opts *bind.WatchOpts, sink chan<- *ContractCommitmentVerified) (event.Subscription, error) {

	logs, sub, err := _Contract.contract.WatchLogs(opts, "CommitmentVerified")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				event := new(ContractCommitmentVerified)
				if err := _Contract.contract.UnpackLog(event, "CommitmentVerified", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event CommitmentVerified(uint256 id, uint8 phase, bytes32 commitmentHash, address prover)
func (_Contract *ContractFilterer) ParseCommitmentVerified(log types.Log) (*ContractCommitmentVerified, error) {
	event := new(ContractCommitmentVerified)
	if err := _Contract.contract.UnpackLog(event, "CommitmentVerified", log); err != nil {
		return nil, err
	}
