...
// VerifyBeefyMerkleLeaf is a free data retrieval call binding the contract method 0x8542bd76.
//
// Solidity: function verifyBeefyMerkleLeaf(bytes32 beefyMMRLeaf, (bytes32[],bytes32,bytes32[],uint64) proof) view returns(bool)
...
// VerifyNewestMMRLeaf is a free data retrieval call binding the contract method 0x9581edf4.
//
// Solidity: function verifyNewestMMRLeaf((uint8,uint32,bytes32,bytes32,uint64,uint32,bytes32) leaf, bytes32 root, (bytes32[],bytes32,bytes32[],uint64) proof) view returns()
...
// CompleteSignatureCommitment is a paid mutator transaction binding the contract method 0x74561f81.
//
// Solidity: function completeSignatureCommitment(uint256 id, (bytes32,uint64,uint32) commitment, (bytes[],uint256[],address[],bytes32[][]) validatorProof, (uint8,uint32,bytes32,bytes32,uint64,uint32,bytes32) latestMMRLeaf, (bytes32[],bytes32,bytes32[],uint64) proof) returns()
