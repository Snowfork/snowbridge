...
func (_Contract *ContractTransactor) CompleteSignatureCommitment(opts *bind.TransactOpts, id *big.Int, commitment LightClientBridgeCommitment, signatures [][]byte, validatorPositions []*big.Int, validatorPublicKeys []common.Address, validatorPublicKeyMerkleProofs [][][32]byte) (*types.Transaction, error) {
...
//
// Solidity: function completeSignatureCommitment(uint256 id, (bytes32,uint64,uint32) commitment, bytes[] signatures, uint256[] validatorPositions, address[] validatorPublicKeys, bytes32[][] validatorPublicKeyMerkleProofs) returns()
func (_Contract *ContractSession) CompleteSignatureCommitment(id *big.Int, commitment LightClientBridgeCommitment, signatures [][]byte, validatorPositions []*big.Int, validatorPublicKeys []common.Address, validatorPublicKeyMerkleProofs [][][32]byte) (*types.Transaction, error) {
...
//
// Solidity: function completeSignatureCommitment(uint256 id, (bytes32,uint64,uint32) commitment, bytes[] signatures, uint256[] validatorPositions, address[] validatorPublicKeys, bytes32[][] validatorPublicKeyMerkleProofs) returns()
func (_Contract *ContractTransactorSession) CompleteSignatureCommitment(id *big.Int, commitment LightClientBridgeCommitment, signatures [][]byte, validatorPositions []*big.Int, validatorPublicKeys []common.Address, validatorPublicKeyMerkleProofs [][][32]byte) (*types.Transaction, error) {
	return _Contract.Contract.CompleteSignatureCommitment(&_Contract.TransactOpts, id, commitment, signatures, validatorPositions, validatorPublicKeys, validatorPublicKeyMerkleProofs)
}
