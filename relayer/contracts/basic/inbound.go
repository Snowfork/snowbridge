...
// Submit is a paid mutator transaction binding the contract method 0x022f6d95.
//
// Solidity: function submit((address,uint64,bytes)[] _messages, (bytes32,uint32,bytes32,bytes32) _ownParachainHeadPartial, (uint256,uint256,bytes32[]) _parachainHeadProof, (uint32,bytes32,uint64,uint32,bytes32) _beefyMMRLeafPartial, uint256 _beefyMMRLeafIndex, uint256 _beefyMMRLeafCount, bytes32[] _beefyMMRLeafProof) returns()
func (_BasicInboundChannel *BasicInboundChannelTransactor) Submit(opts *bind.TransactOpts, _messages []BasicInboundChannelMessage, _ownParachainHeadPartial ParachainLightClientOwnParachainHeadPartial, _parachainHeadProof ParachainLightClientParachainHeadProof, _beefyMMRLeafPartial ParachainLightClientBeefyMMRLeafPartial, _beefyMMRLeafIndex *big.Int, _beefyMMRLeafCount *big.Int, _beefyMMRLeafProof [][32]byte) (*types.Transaction, error) {
	return _BasicInboundChannel.contract.Transact(opts, "submit", _messages, _ownParachainHeadPartial, _parachainHeadProof, _beefyMMRLeafPartial, _beefyMMRLeafIndex, _beefyMMRLeafCount, _beefyMMRLeafProof)
}

// Submit is a paid mutator transaction binding the contract method 0x022f6d95.
//
// Solidity: function submit((address,uint64,bytes)[] _messages, (bytes32,uint32,bytes32,bytes32) _ownParachainHeadPartial, (uint256,uint256,bytes32[]) _parachainHeadProof, (uint32,bytes32,uint64,uint32,bytes32) _beefyMMRLeafPartial, uint256 _beefyMMRLeafIndex, uint256 _beefyMMRLeafCount, bytes32[] _beefyMMRLeafProof) returns()
func (_BasicInboundChannel *BasicInboundChannelSession) Submit(_messages []BasicInboundChannelMessage, _ownParachainHeadPartial ParachainLightClientOwnParachainHeadPartial, _parachainHeadProof ParachainLightClientParachainHeadProof, _beefyMMRLeafPartial ParachainLightClientBeefyMMRLeafPartial, _beefyMMRLeafIndex *big.Int, _beefyMMRLeafCount *big.Int, _beefyMMRLeafProof [][32]byte) (*types.Transaction, error) {
	return _BasicInboundChannel.Contract.Submit(&_BasicInboundChannel.TransactOpts, _messages, _ownParachainHeadPartial, _parachainHeadProof, _beefyMMRLeafPartial, _beefyMMRLeafIndex, _beefyMMRLeafCount, _beefyMMRLeafProof)
}

// Submit is a paid mutator transaction binding the contract method 0x022f6d95.
//
// Solidity: function submit((address,uint64,bytes)[] _messages, (bytes32,uint32,bytes32,bytes32) _ownParachainHeadPartial, (uint256,uint256,bytes32[]) _parachainHeadProof, (uint32,bytes32,uint64,uint32,bytes32) _beefyMMRLeafPartial, uint256 _beefyMMRLeafIndex, uint256 _beefyMMRLeafCount, bytes32[] _beefyMMRLeafProof) returns()
func (_BasicInboundChannel *BasicInboundChannelTransactorSession) Submit(_messages []BasicInboundChannelMessage, _ownParachainHeadPartial ParachainLightClientOwnParachainHeadPartial, _parachainHeadProof ParachainLightClientParachainHeadProof, _beefyMMRLeafPartial ParachainLightClientBeefyMMRLeafPartial, _beefyMMRLeafIndex *big.Int, _beefyMMRLeafCount *big.Int, _beefyMMRLeafProof [][32]byte) (*types.Transaction, error) {
	return _BasicInboundChannel.Contract.Submit(&_BasicInboundChannel.TransactOpts, _messages, _ownParachainHeadPartial, _parachainHeadProof, _beefyMMRLeafPartial, _beefyMMRLeafIndex, _beefyMMRLeafCount, _beefyMMRLeafProof)
}
