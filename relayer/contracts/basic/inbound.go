...
// Submit is a paid mutator transaction binding the contract method 0xf204407e.
//
// Solidity: function submit((bytes32,uint64,(uint64,address,bytes)[]) bundle, bytes32[] leafProof, bool[] hashSides, bytes proof) returns()
