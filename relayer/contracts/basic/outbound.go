...
func (_BasicOutboundChannel *BasicOutboundChannelTransactor) Submit(opts *bind.TransactOpts, account common.Address, payload []byte, arg2 uint64) (*types.Transaction, error) {
	return _BasicOutboundChannel.contract.Transact(opts, "submit", account, payload, arg2)
}

// Submit is a paid mutator transaction binding the contract method 0xadf12082.
//
// Solidity: function submit(address account, bytes payload, uint64 ) returns()
func (_BasicOutboundChannel *BasicOutboundChannelSession) Submit(account common.Address, payload []byte, arg2 uint64) (*types.Transaction, error) {
	return _BasicOutboundChannel.Contract.Submit(&_BasicOutboundChannel.TransactOpts, account, payload, arg2)
}

// Submit is a paid mutator transaction binding the contract method 0xadf12082.
//
// Solidity: function submit(address account, bytes payload, uint64 ) returns()
func (_BasicOutboundChannel *BasicOutboundChannelTransactorSession) Submit(account common.Address, payload []byte, arg2 uint64) (*types.Transaction, error) {
	return _BasicOutboundChannel.Contract.Submit(&_BasicOutboundChannel.TransactOpts, account, payload, arg2)
}
...
//
// Solidity: event Message(address source, address account, uint64 nonce, bytes payload)
