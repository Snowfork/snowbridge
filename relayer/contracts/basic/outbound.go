...
//
// Solidity: function nonce(address ) view returns(uint64)
func (_BasicOutboundChannel *BasicOutboundChannelCaller) Nonce(opts *bind.CallOpts, arg0 common.Address) (uint64, error) {
	var out []interface{}
	err := _BasicOutboundChannel.contract.Call(opts, &out, "nonce", arg0)
...
//
// Solidity: function nonce(address ) view returns(uint64)
func (_BasicOutboundChannel *BasicOutboundChannelSession) Nonce(arg0 common.Address) (uint64, error) {
	return _BasicOutboundChannel.Contract.Nonce(&_BasicOutboundChannel.CallOpts, arg0)
}

// Nonce is a free data retrieval call binding the contract method 0x70ae92d2.
//
// Solidity: function nonce(address ) view returns(uint64)
func (_BasicOutboundChannel *BasicOutboundChannelCallerSession) Nonce(arg0 common.Address) (uint64, error) {
	return _BasicOutboundChannel.Contract.Nonce(&_BasicOutboundChannel.CallOpts, arg0)
}
...
//
// Solidity: function submit(address account, bytes payload, uint64 weight) returns()
func (_BasicOutboundChannel *BasicOutboundChannelTransactor) Submit(opts *bind.TransactOpts, account common.Address, payload []byte, weight uint64) (*types.Transaction, error) {
	return _BasicOutboundChannel.contract.Transact(opts, "submit", account, payload, weight)
}

// Submit is a paid mutator transaction binding the contract method 0xadf12082.
//
// Solidity: function submit(address account, bytes payload, uint64 weight) returns()
func (_BasicOutboundChannel *BasicOutboundChannelSession) Submit(account common.Address, payload []byte, weight uint64) (*types.Transaction, error) {
	return _BasicOutboundChannel.Contract.Submit(&_BasicOutboundChannel.TransactOpts, account, payload, weight)
}

// Submit is a paid mutator transaction binding the contract method 0xadf12082.
//
// Solidity: function submit(address account, bytes payload, uint64 weight) returns()
func (_BasicOutboundChannel *BasicOutboundChannelTransactorSession) Submit(account common.Address, payload []byte, weight uint64) (*types.Transaction, error) {
	return _BasicOutboundChannel.Contract.Submit(&_BasicOutboundChannel.TransactOpts, account, payload, weight)
}
...
// FilterMessage is a free log retrieval operation binding the contract event 0xa5f39ee370f70ab738604498959665b56d7cfdcfc84c052d752404fbc09ae3df.
//
// Solidity: event Message(address source, address account, uint64 nonce, uint64 weight, bytes payload)
...
// WatchMessage is a free log subscription operation binding the contract event 0xa5f39ee370f70ab738604498959665b56d7cfdcfc84c052d752404fbc09ae3df.
//
// Solidity: event Message(address source, address account, uint64 nonce, uint64 weight, bytes payload)
...
// ParseMessage is a log parse operation binding the contract event 0xa5f39ee370f70ab738604498959665b56d7cfdcfc84c052d752404fbc09ae3df.
//
// Solidity: event Message(address source, address account, uint64 nonce, uint64 weight, bytes payload)
