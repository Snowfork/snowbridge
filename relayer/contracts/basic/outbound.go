...
//
// Solidity: function submit(address _account, bytes _payload, uint64 weight) returns()
func (_BasicOutboundChannel *BasicOutboundChannelTransactor) Submit(opts *bind.TransactOpts, _account common.Address, _payload []byte, weight uint64) (*types.Transaction, error) {
	return _BasicOutboundChannel.contract.Transact(opts, "submit", _account, _payload, weight)
}

// Submit is a paid mutator transaction binding the contract method 0xadf12082.
//
// Solidity: function submit(address _account, bytes _payload, uint64 weight) returns()
func (_BasicOutboundChannel *BasicOutboundChannelSession) Submit(_account common.Address, _payload []byte, weight uint64) (*types.Transaction, error) {
	return _BasicOutboundChannel.Contract.Submit(&_BasicOutboundChannel.TransactOpts, _account, _payload, weight)
}

// Submit is a paid mutator transaction binding the contract method 0xadf12082.
//
// Solidity: function submit(address _account, bytes _payload, uint64 weight) returns()
func (_BasicOutboundChannel *BasicOutboundChannelTransactorSession) Submit(_account common.Address, _payload []byte, weight uint64) (*types.Transaction, error) {
	return _BasicOutboundChannel.Contract.Submit(&_BasicOutboundChannel.TransactOpts, _account, _payload, weight)
}
...
// FilterMessage is a free log retrieval operation binding the contract event 0xbe48f60e5cc42a244b79a80d1415a57f17848d7062caa22340c0b8546499dc92.
//
// Solidity: event Message(address source, address account, uint64 nonce, bytes payload, uint64 weight)
...
// WatchMessage is a free log subscription operation binding the contract event 0xbe48f60e5cc42a244b79a80d1415a57f17848d7062caa22340c0b8546499dc92.
//
// Solidity: event Message(address source, address account, uint64 nonce, bytes payload, uint64 weight)
...
// ParseMessage is a log parse operation binding the contract event 0xbe48f60e5cc42a244b79a80d1415a57f17848d7062caa22340c0b8546499dc92.
//
// Solidity: event Message(address source, address account, uint64 nonce, bytes payload, uint64 weight)
