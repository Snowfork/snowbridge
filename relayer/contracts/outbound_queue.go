...
func (_OutboundQueue *OutboundQueueCaller) Registry(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _OutboundQueue.contract.Call(opts, &out, "registry")
...
//
// Solidity: function registry() view returns(address)
func (_OutboundQueue *OutboundQueueSession) Registry() (common.Address, error) {
	return _OutboundQueue.Contract.Registry(&_OutboundQueue.CallOpts)
}

// Registry is a free data retrieval call binding the contract method 0x7b103999.
//
// Solidity: function registry() view returns(address)
func (_OutboundQueue *OutboundQueueCallerSession) Registry() (common.Address, error) {
	return _OutboundQueue.Contract.Registry(&_OutboundQueue.CallOpts)
}
