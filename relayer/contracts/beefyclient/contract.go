...
// SubmitFinalWithHandover is a paid mutator transaction binding the contract method 0x7edbd084.
//
// Solidity: function submitFinalWithHandover(uint256 requestID, (uint32,uint64,(bytes32,bytes,bytes)) commitment, ((uint8,bytes32,bytes32)[],uint256[],address[],bytes32[][]) proof, (uint8,uint32,bytes32,uint64,uint32,bytes32,bytes32) leaf, bytes32[] leafProof, uint256 leafProofOrder) returns()
func (_BeefyClient *BeefyClientTransactor) SubmitFinalWithHandover(opts *bind.TransactOpts, requestID *big.Int, commitment BeefyClientCommitment, proof BeefyClientValidatorMultiProof, leaf BeefyClientMMRLeaf, leafProof [][32]byte, leafProofOrder *big.Int) (*types.Transaction, error) {
	return _BeefyClient.contract.Transact(opts, "submitFinalWithHandover", requestID, commitment, proof, leaf, leafProof, leafProofOrder)
}

// SubmitFinalWithHandover is a paid mutator transaction binding the contract method 0x7edbd084.
//
// Solidity: function submitFinalWithHandover(uint256 requestID, (uint32,uint64,(bytes32,bytes,bytes)) commitment, ((uint8,bytes32,bytes32)[],uint256[],address[],bytes32[][]) proof, (uint8,uint32,bytes32,uint64,uint32,bytes32,bytes32) leaf, bytes32[] leafProof, uint256 leafProofOrder) returns()
func (_BeefyClient *BeefyClientSession) SubmitFinalWithHandover(requestID *big.Int, commitment BeefyClientCommitment, proof BeefyClientValidatorMultiProof, leaf BeefyClientMMRLeaf, leafProof [][32]byte, leafProofOrder *big.Int) (*types.Transaction, error) {
	return _BeefyClient.Contract.SubmitFinalWithHandover(&_BeefyClient.TransactOpts, requestID, commitment, proof, leaf, leafProof, leafProofOrder)
}

// SubmitFinalWithHandover is a paid mutator transaction binding the contract method 0x7edbd084.
//
// Solidity: function submitFinalWithHandover(uint256 requestID, (uint32,uint64,(bytes32,bytes,bytes)) commitment, ((uint8,bytes32,bytes32)[],uint256[],address[],bytes32[][]) proof, (uint8,uint32,bytes32,uint64,uint32,bytes32,bytes32) leaf, bytes32[] leafProof, uint256 leafProofOrder) returns()
func (_BeefyClient *BeefyClientTransactorSession) SubmitFinalWithHandover(requestID *big.Int, commitment BeefyClientCommitment, proof BeefyClientValidatorMultiProof, leaf BeefyClientMMRLeaf, leafProof [][32]byte, leafProofOrder *big.Int) (*types.Transaction, error) {
	return _BeefyClient.Contract.SubmitFinalWithHandover(&_BeefyClient.TransactOpts, requestID, commitment, proof, leaf, leafProof, leafProofOrder)
}

// SubmitInitial is a paid mutator transaction binding the contract method 0x3fefacf1.
//
...
// SubmitInitialWithHandover is a paid mutator transaction binding the contract method 0x51af1b8a.
//
