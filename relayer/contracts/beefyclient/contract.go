...
// SubmitFinal is a paid mutator transaction binding the contract method 0x6b7b17cd.
//
// Solidity: function submitFinal(uint256 requestID, (uint32,uint64,(bytes32,bytes,bytes)) commitment, ((bytes32,bytes32)[],uint256[],address[],bytes32[][]) proof, (uint8,uint32,bytes32,uint64,uint32,bytes32,bytes32) leaf, (bytes32[],uint64) leafProof) returns()
...
// SubmitFinal0 is a paid mutator transaction binding the contract method 0xfe8473ad.
//
// Solidity: function submitFinal(uint256 requestID, (uint32,uint64,(bytes32,bytes,bytes)) commitment, ((bytes32,bytes32)[],uint256[],address[],bytes32[][]) proof) returns()
...
// SubmitInitial is a paid mutator transaction binding the contract method 0x125eb2a1.
//
// Solidity: function submitInitial(bytes32 commitmentHash, uint64 validatorSetID, uint256[] bitfield, ((bytes32,bytes32),uint256,address,bytes32[]) proof) payable returns()
