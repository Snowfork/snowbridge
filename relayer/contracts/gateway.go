...
// ParachainVerificationDigestItem is an auto generated low-level Go binding around an user-defined struct.
type ParachainVerificationDigestItem struct {
	Kind              *big.Int
	ConsensusEngineID [4]byte
	Data              []byte
}

// ParachainVerificationHeadProof is an auto generated low-level Go binding around an user-defined struct.
type ParachainVerificationHeadProof struct {
	Pos   *big.Int
	Width *big.Int
	Proof [][32]byte
}

// ParachainVerificationParachainHeader is an auto generated low-level Go binding around an user-defined struct.
type ParachainVerificationParachainHeader struct {
	ParentHash     [32]byte
	Number         *big.Int
	StateRoot      [32]byte
	ExtrinsicsRoot [32]byte
	DigestItems    []ParachainVerificationDigestItem
}

// ParachainVerificationProof is an auto generated low-level Go binding around an user-defined struct.
type ParachainVerificationProof struct {
	Header    ParachainVerificationParachainHeader
	HeadProof ParachainVerificationHeadProof
}
...
// Xcm is an auto generated low-level Go binding around an user-defined struct.
type Xcm struct {
	Kind uint8
	Data []byte
}
...
// V2Submit is a paid mutator transaction binding the contract method 0x3a9a724a.
//
// Solidity: function v2_submit((bytes32,uint64,bytes32,(uint8,uint64,bytes)[]) message, bytes32[] messageProof, ((bytes32,uint256,bytes32,bytes32,(uint256,bytes4,bytes)[]),(uint256,uint256,bytes32[])) headerProof, ((uint8,uint32,bytes32,uint64,uint32,bytes32),bytes32[],uint256) beefyProof, bytes32 rewardAddress) returns()
func (_Gateway *GatewayTransactor) V2Submit(opts *bind.TransactOpts, message InboundMessage, messageProof [][32]byte, headerProof ParachainVerificationProof, beefyProof BeefyVerificationProof, rewardAddress [32]byte) (*types.Transaction, error) {
	return _Gateway.contract.Transact(opts, "v2_submit", message, messageProof, headerProof, beefyProof, rewardAddress)
}

// V2Submit is a paid mutator transaction binding the contract method 0x3a9a724a.
//
// Solidity: function v2_submit((bytes32,uint64,bytes32,(uint8,uint64,bytes)[]) message, bytes32[] messageProof, ((bytes32,uint256,bytes32,bytes32,(uint256,bytes4,bytes)[]),(uint256,uint256,bytes32[])) headerProof, ((uint8,uint32,bytes32,uint64,uint32,bytes32),bytes32[],uint256) beefyProof, bytes32 rewardAddress) returns()
func (_Gateway *GatewaySession) V2Submit(message InboundMessage, messageProof [][32]byte, headerProof ParachainVerificationProof, beefyProof BeefyVerificationProof, rewardAddress [32]byte) (*types.Transaction, error) {
	return _Gateway.Contract.V2Submit(&_Gateway.TransactOpts, message, messageProof, headerProof, beefyProof, rewardAddress)
}

// V2Submit is a paid mutator transaction binding the contract method 0x3a9a724a.
//
// Solidity: function v2_submit((bytes32,uint64,bytes32,(uint8,uint64,bytes)[]) message, bytes32[] messageProof, ((bytes32,uint256,bytes32,bytes32,(uint256,bytes4,bytes)[]),(uint256,uint256,bytes32[])) headerProof, ((uint8,uint32,bytes32,uint64,uint32,bytes32),bytes32[],uint256) beefyProof, bytes32 rewardAddress) returns()
func (_Gateway *GatewayTransactorSession) V2Submit(message InboundMessage, messageProof [][32]byte, headerProof ParachainVerificationProof, beefyProof BeefyVerificationProof, rewardAddress [32]byte) (*types.Transaction, error) {
	return _Gateway.Contract.V2Submit(&_Gateway.TransactOpts, message, messageProof, headerProof, beefyProof, rewardAddress)
}
