...
// TransactMessage is an auto generated low-level Go binding around an user-defined struct.
...
// Transact is a paid mutator transaction binding the contract method 0xbb450536.
//
// Solidity: function transact(uint32 destinationChain, (uint8,uint128,(uint64,uint64),bytes) message) payable returns()
func (_Gateway *GatewayTransactor) Transact(opts *bind.TransactOpts, destinationChain uint32, message TransactMessage) (*types.Transaction, error) {
	return _Gateway.contract.Transact(opts, "transact", destinationChain, message)
}

// Transact is a paid mutator transaction binding the contract method 0xbb450536.
//
// Solidity: function transact(uint32 destinationChain, (uint8,uint128,(uint64,uint64),bytes) message) payable returns()
func (_Gateway *GatewaySession) Transact(destinationChain uint32, message TransactMessage) (*types.Transaction, error) {
	return _Gateway.Contract.Transact(&_Gateway.TransactOpts, destinationChain, message)
}

// Transact is a paid mutator transaction binding the contract method 0xbb450536.
//
// Solidity: function transact(uint32 destinationChain, (uint8,uint128,(uint64,uint64),bytes) message) payable returns()
func (_Gateway *GatewayTransactorSession) Transact(destinationChain uint32, message TransactMessage) (*types.Transaction, error) {
	return _Gateway.Contract.Transact(&_Gateway.TransactOpts, destinationChain, message)
}
