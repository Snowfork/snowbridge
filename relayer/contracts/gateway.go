...
// AGENTEXECUTOR is a paid mutator transaction binding the contract method 0x423e69b6.
//
// Solidity: function AGENT_EXECUTOR() returns(address)
func (_Gateway *GatewayTransactor) AGENTEXECUTOR(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _Gateway.contract.Transact(opts, "AGENT_EXECUTOR")
}

// AGENTEXECUTOR is a paid mutator transaction binding the contract method 0x423e69b6.
//
// Solidity: function AGENT_EXECUTOR() returns(address)
func (_Gateway *GatewaySession) AGENTEXECUTOR() (*types.Transaction, error) {
	return _Gateway.Contract.AGENTEXECUTOR(&_Gateway.TransactOpts)
}

// AGENTEXECUTOR is a paid mutator transaction binding the contract method 0x423e69b6.
//
// Solidity: function AGENT_EXECUTOR() returns(address)
func (_Gateway *GatewayTransactorSession) AGENTEXECUTOR() (*types.Transaction, error) {
	return _Gateway.Contract.AGENTEXECUTOR(&_Gateway.TransactOpts)
}

// BEEFYCLIENT is a paid mutator transaction binding the contract method 0x90ffc4f9.
//
// Solidity: function BEEFY_CLIENT() returns(address)
func (_Gateway *GatewayTransactor) BEEFYCLIENT(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _Gateway.contract.Transact(opts, "BEEFY_CLIENT")
}

// BEEFYCLIENT is a paid mutator transaction binding the contract method 0x90ffc4f9.
//
// Solidity: function BEEFY_CLIENT() returns(address)
func (_Gateway *GatewaySession) BEEFYCLIENT() (*types.Transaction, error) {
	return _Gateway.Contract.BEEFYCLIENT(&_Gateway.TransactOpts)
}

// BEEFYCLIENT is a paid mutator transaction binding the contract method 0x90ffc4f9.
//
// Solidity: function BEEFY_CLIENT() returns(address)
func (_Gateway *GatewayTransactorSession) BEEFYCLIENT() (*types.Transaction, error) {
	return _Gateway.Contract.BEEFYCLIENT(&_Gateway.TransactOpts)
}
