...
// AgentExecutor is a free data retrieval call binding the contract method 0xfe18c798.
//
// Solidity: function agentExecutor() view returns(address)
func (_Gateway *GatewayCaller) AgentExecutor(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _Gateway.contract.Call(opts, &out, "agentExecutor")
...
//
// Solidity: function agentExecutor() view returns(address)
func (_Gateway *GatewaySession) AgentExecutor() (common.Address, error) {
	return _Gateway.Contract.AgentExecutor(&_Gateway.CallOpts)
}

// AgentExecutor is a free data retrieval call binding the contract method 0xfe18c798.
//
// Solidity: function agentExecutor() view returns(address)
func (_Gateway *GatewayCallerSession) AgentExecutor() (common.Address, error) {
	return _Gateway.Contract.AgentExecutor(&_Gateway.CallOpts)
}
