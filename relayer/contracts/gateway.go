...
// SubmitV1 is a paid mutator transaction binding the contract method 0x9fdb7e6f.
//
// Solidity: function submitV1((bytes32,uint64,uint8,bytes,uint64,uint256,uint256,bytes32) message, bytes32[] messageProof, ((bytes32,uint256,bytes32,bytes32,(uint256,bytes4,bytes)[]),(uint256,uint256,bytes32[])) headerProof, ((uint8,uint32,bytes32,uint64,uint32,bytes32),bytes32[],uint256) beefyProof) returns()
func (_Gateway *GatewayTransactor) SubmitV1(opts *bind.TransactOpts, message InboundMessage, messageProof [][32]byte, headerProof ParachainVerificationProof, beefyProof BeefyVerificationProof) (*types.Transaction, error) {
	return _Gateway.contract.Transact(opts, "submitV1", message, messageProof, headerProof, beefyProof)
}

// SubmitV1 is a paid mutator transaction binding the contract method 0x9fdb7e6f.
//
// Solidity: function submitV1((bytes32,uint64,uint8,bytes,uint64,uint256,uint256,bytes32) message, bytes32[] messageProof, ((bytes32,uint256,bytes32,bytes32,(uint256,bytes4,bytes)[]),(uint256,uint256,bytes32[])) headerProof, ((uint8,uint32,bytes32,uint64,uint32,bytes32),bytes32[],uint256) beefyProof) returns()
func (_Gateway *GatewaySession) SubmitV1(message InboundMessage, messageProof [][32]byte, headerProof ParachainVerificationProof, beefyProof BeefyVerificationProof) (*types.Transaction, error) {
	return _Gateway.Contract.SubmitV1(&_Gateway.TransactOpts, message, messageProof, headerProof, beefyProof)
}

// SubmitV1 is a paid mutator transaction binding the contract method 0x9fdb7e6f.
//
// Solidity: function submitV1((bytes32,uint64,uint8,bytes,uint64,uint256,uint256,bytes32) message, bytes32[] messageProof, ((bytes32,uint256,bytes32,bytes32,(uint256,bytes4,bytes)[]),(uint256,uint256,bytes32[])) headerProof, ((uint8,uint32,bytes32,uint64,uint32,bytes32),bytes32[],uint256) beefyProof) returns()
func (_Gateway *GatewayTransactorSession) SubmitV1(message InboundMessage, messageProof [][32]byte, headerProof ParachainVerificationProof, beefyProof BeefyVerificationProof) (*types.Transaction, error) {
	return _Gateway.Contract.SubmitV1(&_Gateway.TransactOpts, message, messageProof, headerProof, beefyProof)
}
