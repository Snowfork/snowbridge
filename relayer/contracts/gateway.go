...
// ChannelFeeRewardOf is a free data retrieval call binding the contract method 0xa029cc18.
//
// Solidity: function channelFeeRewardOf(uint256 paraID) view returns(uint256, uint256)
func (_Gateway *GatewayCaller) ChannelFeeRewardOf(opts *bind.CallOpts, paraID *big.Int) (*big.Int, *big.Int, error) {
	var out []interface{}
	err := _Gateway.contract.Call(opts, &out, "channelFeeRewardOf", paraID)
...
//
// Solidity: function channelFeeRewardOf(uint256 paraID) view returns(uint256, uint256)
func (_Gateway *GatewaySession) ChannelFeeRewardOf(paraID *big.Int) (*big.Int, *big.Int, error) {
	return _Gateway.Contract.ChannelFeeRewardOf(&_Gateway.CallOpts, paraID)
}

// ChannelFeeRewardOf is a free data retrieval call binding the contract method 0xa029cc18.
//
// Solidity: function channelFeeRewardOf(uint256 paraID) view returns(uint256, uint256)
func (_Gateway *GatewayCallerSession) ChannelFeeRewardOf(paraID *big.Int) (*big.Int, *big.Int, error) {
	return _Gateway.Contract.ChannelFeeRewardOf(&_Gateway.CallOpts, paraID)
}
...
// SendTransact is a paid mutator transaction binding the contract method 0x368d49cf.
//
// Solidity: function sendTransact(uint256 destinationChain, bytes payload) payable returns()
func (_Gateway *GatewayTransactor) SendTransact(opts *bind.TransactOpts, destinationChain *big.Int, payload []byte) (*types.Transaction, error) {
	return _Gateway.contract.Transact(opts, "sendTransact", destinationChain, payload)
}

// SendTransact is a paid mutator transaction binding the contract method 0x368d49cf.
//
// Solidity: function sendTransact(uint256 destinationChain, bytes payload) payable returns()
func (_Gateway *GatewaySession) SendTransact(destinationChain *big.Int, payload []byte) (*types.Transaction, error) {
	return _Gateway.Contract.SendTransact(&_Gateway.TransactOpts, destinationChain, payload)
}

// SendTransact is a paid mutator transaction binding the contract method 0x368d49cf.
//
// Solidity: function sendTransact(uint256 destinationChain, bytes payload) payable returns()
func (_Gateway *GatewayTransactorSession) SendTransact(destinationChain *big.Int, payload []byte) (*types.Transaction, error) {
	return _Gateway.Contract.SendTransact(&_Gateway.TransactOpts, destinationChain, payload)
}

// SendTransact0 is a paid mutator transaction binding the contract method 0x55cc99c1.
//
// Solidity: function sendTransact(uint256 destinationChain, bytes payload, uint256 extraFee, uint64 refTime, uint64 proofSize) payable returns()
func (_Gateway *GatewayTransactor) SendTransact0(opts *bind.TransactOpts, destinationChain *big.Int, payload []byte, extraFee *big.Int, refTime uint64, proofSize uint64) (*types.Transaction, error) {
	return _Gateway.contract.Transact(opts, "sendTransact0", destinationChain, payload, extraFee, refTime, proofSize)
}

// SendTransact0 is a paid mutator transaction binding the contract method 0x55cc99c1.
//
// Solidity: function sendTransact(uint256 destinationChain, bytes payload, uint256 extraFee, uint64 refTime, uint64 proofSize) payable returns()
func (_Gateway *GatewaySession) SendTransact0(destinationChain *big.Int, payload []byte, extraFee *big.Int, refTime uint64, proofSize uint64) (*types.Transaction, error) {
	return _Gateway.Contract.SendTransact0(&_Gateway.TransactOpts, destinationChain, payload, extraFee, refTime, proofSize)
}

// SendTransact0 is a paid mutator transaction binding the contract method 0x55cc99c1.
//
// Solidity: function sendTransact(uint256 destinationChain, bytes payload, uint256 extraFee, uint64 refTime, uint64 proofSize) payable returns()
func (_Gateway *GatewayTransactorSession) SendTransact0(destinationChain *big.Int, payload []byte, extraFee *big.Int, refTime uint64, proofSize uint64) (*types.Transaction, error) {
	return _Gateway.Contract.SendTransact0(&_Gateway.TransactOpts, destinationChain, payload, extraFee, refTime, proofSize)
}

// SubmitInbound is a paid mutator transaction binding the contract method 0x920ee69f.
//
// Solidity: function submitInbound((uint256,uint64,uint8,bytes) message, bytes32[] leafProof, ((bytes32,uint256,bytes32,bytes32,(uint256,bytes4,bytes)[]),(uint256,uint256,bytes32[]),(uint8,uint32,bytes32,uint64,uint32,bytes32),bytes32[],uint256) headerProof) returns()
...
//
// Solidity: event TokenRegistered(address token)
...
// FilterTokenSent is a free log retrieval operation binding the contract event 0xe1ae29e81ebd3cc6a74fb91c2d9f33e3d80313f1d106f2b24e62cac4bfc86d98.
//
// Solidity: event TokenSent(address token, uint256 destinationChain, bytes destinationAddress, uint128 amount)
func (_Gateway *GatewayFilterer) FilterTokenSent(opts *bind.FilterOpts) (*GatewayTokenSentIterator, error) {

	logs, sub, err := _Gateway.contract.FilterLogs(opts, "TokenSent")
	if err != nil {
		return nil, err
	}
...
// WatchTokenSent is a free log subscription operation binding the contract event 0xe1ae29e81ebd3cc6a74fb91c2d9f33e3d80313f1d106f2b24e62cac4bfc86d98.
//
// Solidity: event TokenSent(address token, uint256 destinationChain, bytes destinationAddress, uint128 amount)
func (_Gateway *GatewayFilterer) WatchTokenSent(opts *bind.WatchOpts, sink chan<- *GatewayTokenSent) (event.Subscription, error) {

	logs, sub, err := _Gateway.contract.WatchLogs(opts, "TokenSent")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
...
// ParseTokenSent is a log parse operation binding the contract event 0xe1ae29e81ebd3cc6a74fb91c2d9f33e3d80313f1d106f2b24e62cac4bfc86d98.
//
// Solidity: event TokenSent(address token, uint256 destinationChain, bytes destinationAddress, uint128 amount)
