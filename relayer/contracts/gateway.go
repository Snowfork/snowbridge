...
// V2InboundNonce is a free data retrieval call binding the contract method 0x48241d1b.
//
// Solidity: function v2_inboundNonce() view returns(uint64)
func (_Gateway *GatewayCaller) V2InboundNonce(opts *bind.CallOpts) (uint64, error) {
	var out []interface{}
	err := _Gateway.contract.Call(opts, &out, "v2_inboundNonce")
...
//
// Solidity: function v2_inboundNonce() view returns(uint64)
func (_Gateway *GatewaySession) V2InboundNonce() (uint64, error) {
	return _Gateway.Contract.V2InboundNonce(&_Gateway.CallOpts)
}

// V2InboundNonce is a free data retrieval call binding the contract method 0x48241d1b.
//
// Solidity: function v2_inboundNonce() view returns(uint64)
func (_Gateway *GatewayCallerSession) V2InboundNonce() (uint64, error) {
	return _Gateway.Contract.V2InboundNonce(&_Gateway.CallOpts)
}
