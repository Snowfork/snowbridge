...
// Weight is an auto generated low-level Go binding around an user-defined struct.
type Weight struct {
	RefTime   uint64
	ProofSize uint64
}
...
// QuoteSendCallFee is a free data retrieval call binding the contract method 0x9bf22c58.
//
// Solidity: function quoteSendCallFee(uint128 destinationFee) view returns(uint256)
func (_Gateway *GatewayCaller) QuoteSendCallFee(opts *bind.CallOpts, destinationFee *big.Int) (*big.Int, error) {
	var out []interface{}
	err := _Gateway.contract.Call(opts, &out, "quoteSendCallFee", destinationFee)
...
//
// Solidity: function quoteSendCallFee(uint128 destinationFee) view returns(uint256)
func (_Gateway *GatewaySession) QuoteSendCallFee(destinationFee *big.Int) (*big.Int, error) {
	return _Gateway.Contract.QuoteSendCallFee(&_Gateway.CallOpts, destinationFee)
}

// QuoteSendCallFee is a free data retrieval call binding the contract method 0x9bf22c58.
//
// Solidity: function quoteSendCallFee(uint128 destinationFee) view returns(uint256)
func (_Gateway *GatewayCallerSession) QuoteSendCallFee(destinationFee *big.Int) (*big.Int, error) {
	return _Gateway.Contract.QuoteSendCallFee(&_Gateway.CallOpts, destinationFee)
}
...
// SendCall is a paid mutator transaction binding the contract method 0x86c2b257.
//
// Solidity: function sendCall(uint32 destinationChain, uint8 originKind, uint128 destinationFee, (uint64,uint64) weightAtMost, bytes call) payable returns()
func (_Gateway *GatewayTransactor) SendCall(opts *bind.TransactOpts, destinationChain uint32, originKind uint8, destinationFee *big.Int, weightAtMost Weight, call []byte) (*types.Transaction, error) {
	return _Gateway.contract.Transact(opts, "sendCall", destinationChain, originKind, destinationFee, weightAtMost, call)
}

// SendCall is a paid mutator transaction binding the contract method 0x86c2b257.
//
// Solidity: function sendCall(uint32 destinationChain, uint8 originKind, uint128 destinationFee, (uint64,uint64) weightAtMost, bytes call) payable returns()
func (_Gateway *GatewaySession) SendCall(destinationChain uint32, originKind uint8, destinationFee *big.Int, weightAtMost Weight, call []byte) (*types.Transaction, error) {
	return _Gateway.Contract.SendCall(&_Gateway.TransactOpts, destinationChain, originKind, destinationFee, weightAtMost, call)
}

// SendCall is a paid mutator transaction binding the contract method 0x86c2b257.
//
// Solidity: function sendCall(uint32 destinationChain, uint8 originKind, uint128 destinationFee, (uint64,uint64) weightAtMost, bytes call) payable returns()
func (_Gateway *GatewayTransactorSession) SendCall(destinationChain uint32, originKind uint8, destinationFee *big.Int, weightAtMost Weight, call []byte) (*types.Transaction, error) {
	return _Gateway.Contract.SendCall(&_Gateway.TransactOpts, destinationChain, originKind, destinationFee, weightAtMost, call)
}
