...
// SubmitInbound is a paid mutator transaction binding the contract method 0xcf5e1f42.
//
// Solidity: function submitInbound((uint256,uint64,uint8,bytes,uint256) message, bytes32[] leafProof, ((bytes32,uint256,bytes32,bytes32,(uint256,bytes4,bytes)[]),(uint256,uint256,bytes32[]),(uint8,uint32,bytes32,uint64,uint32,bytes32),bytes32[],uint256) headerProof) returns()
