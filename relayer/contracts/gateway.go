...
// QuoteSendCallFee is a free data retrieval call binding the contract method 0x1690cd14.
//
// Solidity: function quoteSendCallFee() view returns(uint256)
func (_Gateway *GatewayCaller) QuoteSendCallFee(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
...
//
// Solidity: function quoteSendCallFee() view returns(uint256)
func (_Gateway *GatewaySession) QuoteSendCallFee() (*big.Int, error) {
	return _Gateway.Contract.QuoteSendCallFee(&_Gateway.CallOpts)
}

// QuoteSendCallFee is a free data retrieval call binding the contract method 0x1690cd14.
//
// Solidity: function quoteSendCallFee() view returns(uint256)
func (_Gateway *GatewayCallerSession) QuoteSendCallFee() (*big.Int, error) {
	return _Gateway.Contract.QuoteSendCallFee(&_Gateway.CallOpts)
}
