...
// FIATSHAMIRDOMAINID is a free data retrieval call binding the contract method 0x15fac8c6.
//
// Solidity: function FIAT_SHAMIR_DOMAIN_ID() view returns(bytes)
func (_BeefyClient *BeefyClientCaller) FIATSHAMIRDOMAINID(opts *bind.CallOpts) ([]byte, error) {
	var out []interface{}
	err := _BeefyClient.contract.Call(opts, &out, "FIAT_SHAMIR_DOMAIN_ID")
...
//
// Solidity: function FIAT_SHAMIR_DOMAIN_ID() view returns(bytes)
func (_BeefyClient *BeefyClientSession) FIATSHAMIRDOMAINID() ([]byte, error) {
	return _BeefyClient.Contract.FIATSHAMIRDOMAINID(&_BeefyClient.CallOpts)
}

// FIATSHAMIRDOMAINID is a free data retrieval call binding the contract method 0x15fac8c6.
//
// Solidity: function FIAT_SHAMIR_DOMAIN_ID() view returns(bytes)
func (_BeefyClient *BeefyClientCallerSession) FIATSHAMIRDOMAINID() ([]byte, error) {
	return _BeefyClient.Contract.FIATSHAMIRDOMAINID(&_BeefyClient.CallOpts)
}
...
// ComputeCommitmentHash is a free data retrieval call binding the contract method 0xc6405f31.
//
// Solidity: function computeCommitmentHash((uint32,uint64,(bytes2,bytes)[]) commitment) pure returns(bytes32)
func (_BeefyClient *BeefyClientCaller) ComputeCommitmentHash(opts *bind.CallOpts, commitment BeefyClientCommitment) ([32]byte, error) {
	var out []interface{}
	err := _BeefyClient.contract.Call(opts, &out, "computeCommitmentHash", commitment)
...
//
// Solidity: function computeCommitmentHash((uint32,uint64,(bytes2,bytes)[]) commitment) pure returns(bytes32)
func (_BeefyClient *BeefyClientSession) ComputeCommitmentHash(commitment BeefyClientCommitment) ([32]byte, error) {
	return _BeefyClient.Contract.ComputeCommitmentHash(&_BeefyClient.CallOpts, commitment)
}

// ComputeCommitmentHash is a free data retrieval call binding the contract method 0xc6405f31.
//
// Solidity: function computeCommitmentHash((uint32,uint64,(bytes2,bytes)[]) commitment) pure returns(bytes32)
func (_BeefyClient *BeefyClientCallerSession) ComputeCommitmentHash(commitment BeefyClientCommitment) ([32]byte, error) {
	return _BeefyClient.Contract.ComputeCommitmentHash(&_BeefyClient.CallOpts, commitment)
}
...
func (_BeefyClient *BeefyClientCaller) CreateFiatShamirFinalBitfield(opts *bind.CallOpts, commitment BeefyClientCommitment, bitfield []*big.Int) ([]*big.Int, error) {
	var out []interface{}
	err := _BeefyClient.contract.Call(opts, &out, "createFiatShamirFinalBitfield", commitment, bitfield)
...
//
// Solidity: function createFiatShamirFinalBitfield((uint32,uint64,(bytes2,bytes)[]) commitment, uint256[] bitfield) view returns(uint256[])
func (_BeefyClient *BeefyClientSession) CreateFiatShamirFinalBitfield(commitment BeefyClientCommitment, bitfield []*big.Int) ([]*big.Int, error) {
	return _BeefyClient.Contract.CreateFiatShamirFinalBitfield(&_BeefyClient.CallOpts, commitment, bitfield)
}

// CreateFiatShamirFinalBitfield is a free data retrieval call binding the contract method 0x4b4cfb28.
//
// Solidity: function createFiatShamirFinalBitfield((uint32,uint64,(bytes2,bytes)[]) commitment, uint256[] bitfield) view returns(uint256[])
func (_BeefyClient *BeefyClientCallerSession) CreateFiatShamirFinalBitfield(commitment BeefyClientCommitment, bitfield []*big.Int) ([]*big.Int, error) {
	return _BeefyClient.Contract.CreateFiatShamirFinalBitfield(&_BeefyClient.CallOpts, commitment, bitfield)
}
...
// FiatShamirRequiredSignatures is a free data retrieval call binding the contract method 0x83fe0ea0.
//
// Solidity: function fiatShamirRequiredSignatures() view returns(uint256)
func (_BeefyClient *BeefyClientCaller) FiatShamirRequiredSignatures(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _BeefyClient.contract.Call(opts, &out, "fiatShamirRequiredSignatures")
...
//
// Solidity: function fiatShamirRequiredSignatures() view returns(uint256)
func (_BeefyClient *BeefyClientSession) FiatShamirRequiredSignatures() (*big.Int, error) {
	return _BeefyClient.Contract.FiatShamirRequiredSignatures(&_BeefyClient.CallOpts)
}

// FiatShamirRequiredSignatures is a free data retrieval call binding the contract method 0x83fe0ea0.
//
// Solidity: function fiatShamirRequiredSignatures() view returns(uint256)
func (_BeefyClient *BeefyClientCallerSession) FiatShamirRequiredSignatures() (*big.Int, error) {
	return _BeefyClient.Contract.FiatShamirRequiredSignatures(&_BeefyClient.CallOpts)
}
...
func (_BeefyClient *BeefyClientTransactor) SubmitFiatShamir(opts *bind.TransactOpts, commitment BeefyClientCommitment, bitfield []*big.Int, proofs []BeefyClientValidatorProof, leaf BeefyClientMMRLeaf, leafProof [][32]byte, leafProofOrder *big.Int) (*types.Transaction, error) {
	return _BeefyClient.contract.Transact(opts, "submitFiatShamir", commitment, bitfield, proofs, leaf, leafProof, leafProofOrder)
}

// SubmitFiatShamir is a paid mutator transaction binding the contract method 0xc7d6e93d.
//
// Solidity: function submitFiatShamir((uint32,uint64,(bytes2,bytes)[]) commitment, uint256[] bitfield, (uint8,bytes32,bytes32,uint256,address,bytes32[])[] proofs, (uint8,uint32,bytes32,uint64,uint32,bytes32,bytes32) leaf, bytes32[] leafProof, uint256 leafProofOrder) returns()
func (_BeefyClient *BeefyClientSession) SubmitFiatShamir(commitment BeefyClientCommitment, bitfield []*big.Int, proofs []BeefyClientValidatorProof, leaf BeefyClientMMRLeaf, leafProof [][32]byte, leafProofOrder *big.Int) (*types.Transaction, error) {
	return _BeefyClient.Contract.SubmitFiatShamir(&_BeefyClient.TransactOpts, commitment, bitfield, proofs, leaf, leafProof, leafProofOrder)
}

// SubmitFiatShamir is a paid mutator transaction binding the contract method 0xc7d6e93d.
//
// Solidity: function submitFiatShamir((uint32,uint64,(bytes2,bytes)[]) commitment, uint256[] bitfield, (uint8,bytes32,bytes32,uint256,address,bytes32[])[] proofs, (uint8,uint32,bytes32,uint64,uint32,bytes32,bytes32) leaf, bytes32[] leafProof, uint256 leafProofOrder) returns()
func (_BeefyClient *BeefyClientTransactorSession) SubmitFiatShamir(commitment BeefyClientCommitment, bitfield []*big.Int, proofs []BeefyClientValidatorProof, leaf BeefyClientMMRLeaf, leafProof [][32]byte, leafProofOrder *big.Int) (*types.Transaction, error) {
	return _BeefyClient.Contract.SubmitFiatShamir(&_BeefyClient.TransactOpts, commitment, bitfield, proofs, leaf, leafProof, leafProofOrder)
}
...
// BeefyClientTicketExpiredIterator is returned from FilterTicketExpired and is used to iterate over the raw logs and unpacked data for TicketExpired events raised by the BeefyClient contract.
type BeefyClientTicketExpiredIterator struct {
	Event *BeefyClientTicketExpired // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *BeefyClientTicketExpiredIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(BeefyClientTicketExpired)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *BeefyClientTicketExpiredIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *BeefyClientTicketExpiredIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// BeefyClientTicketExpired represents a TicketExpired event raised by the BeefyClient contract.
type BeefyClientTicketExpired struct {
	Raw types.Log // Blockchain specific contextual infos
}

// FilterTicketExpired is a free log retrieval operation binding the contract event 0x40d3544771f3c2382030d7a42c371f55cb608ac0eaf54ef2fa846da65af1b985.
//
// Solidity: event TicketExpired()
func (_BeefyClient *BeefyClientFilterer) FilterTicketExpired(opts *bind.FilterOpts) (*BeefyClientTicketExpiredIterator, error) {

	logs, sub, err := _BeefyClient.contract.FilterLogs(opts, "TicketExpired")
	if err != nil {
		return nil, err
	}
	return &BeefyClientTicketExpiredIterator{contract: _BeefyClient.contract, event: "TicketExpired", logs: logs, sub: sub}, nil
}

// WatchTicketExpired is a free log subscription operation binding the contract event 0x40d3544771f3c2382030d7a42c371f55cb608ac0eaf54ef2fa846da65af1b985.
//
// Solidity: event TicketExpired()
func (_BeefyClient *BeefyClientFilterer) WatchTicketExpired(opts *bind.WatchOpts, sink chan<- *BeefyClientTicketExpired) (event.Subscription, error) {

	logs, sub, err := _BeefyClient.contract.WatchLogs(opts, "TicketExpired")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(BeefyClientTicketExpired)
				if err := _BeefyClient.contract.UnpackLog(event, "TicketExpired", log); err != nil {
					return err
				}
				event.Raw = log
...
// ParseTicketExpired is a log parse operation binding the contract event 0x40d3544771f3c2382030d7a42c371f55cb608ac0eaf54ef2fa846da65af1b985.
//
// Solidity: event TicketExpired()
func (_BeefyClient *BeefyClientFilterer) ParseTicketExpired(log types.Log) (*BeefyClientTicketExpired, error) {
	event := new(BeefyClientTicketExpired)
	if err := _BeefyClient.contract.UnpackLog(event, "TicketExpired", log); err != nil {
		return nil, err
	}
