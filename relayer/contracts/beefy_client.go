...
// BASESIGNATURECOUNT is a free data retrieval call binding the contract method 0x38d4f9c1.
//
// Solidity: function BASE_SIGNATURE_COUNT() view returns(uint256)
func (_BeefyClient *BeefyClientCaller) BASESIGNATURECOUNT(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _BeefyClient.contract.Call(opts, &out, "BASE_SIGNATURE_COUNT")
...
//
// Solidity: function BASE_SIGNATURE_COUNT() view returns(uint256)
func (_BeefyClient *BeefyClientSession) BASESIGNATURECOUNT() (*big.Int, error) {
	return _BeefyClient.Contract.BASESIGNATURECOUNT(&_BeefyClient.CallOpts)
}

// BASESIGNATURECOUNT is a free data retrieval call binding the contract method 0x38d4f9c1.
//
// Solidity: function BASE_SIGNATURE_COUNT() view returns(uint256)
func (_BeefyClient *BeefyClientCallerSession) BASESIGNATURECOUNT() (*big.Int, error) {
	return _BeefyClient.Contract.BASESIGNATURECOUNT(&_BeefyClient.CallOpts)
}
...
//
// Solidity: function tickets(bytes32 ) view returns(address account, uint64 blockNumber, uint32 validatorSetLen, uint256 signatureCountRequired, uint256 prevRandao, bytes32 bitfieldHash)
func (_BeefyClient *BeefyClientCaller) Tickets(opts *bind.CallOpts, arg0 [32]byte) (struct {
	Account                common.Address
	BlockNumber            uint64
	ValidatorSetLen        uint32
	SignatureCountRequired *big.Int
	PrevRandao             *big.Int
	BitfieldHash           [32]byte
}, error) {
	var out []interface{}
	err := _BeefyClient.contract.Call(opts, &out, "tickets", arg0)
	...
	outstruct.SignatureCountRequired = *abi.ConvertType(out[3], new(*big.Int)).(**big.Int)
	outstruct.PrevRandao = *abi.ConvertType(out[4], new(*big.Int)).(**big.Int)
	outstruct.BitfieldHash = *abi.ConvertType(out[5], new([32]byte)).(*[32]byte)
...
//
// Solidity: function tickets(bytes32 ) view returns(address account, uint64 blockNumber, uint32 validatorSetLen, uint256 signatureCountRequired, uint256 prevRandao, bytes32 bitfieldHash)
func (_BeefyClient *BeefyClientSession) Tickets(arg0 [32]byte) (struct {
	Account                common.Address
	BlockNumber            uint64
	ValidatorSetLen        uint32
	SignatureCountRequired *big.Int
	...
	return _BeefyClient.Contract.Tickets(&_BeefyClient.CallOpts, arg0)
}

// Tickets is a free data retrieval call binding the contract method 0xdf0dd0d5.
//
// Solidity: function tickets(bytes32 ) view returns(address account, uint64 blockNumber, uint32 validatorSetLen, uint256 signatureCountRequired, uint256 prevRandao, bytes32 bitfieldHash)
func (_BeefyClient *BeefyClientCallerSession) Tickets(arg0 [32]byte) (struct {
	Account                common.Address
	BlockNumber            uint64
	ValidatorSetLen        uint32
	SignatureCountRequired *big.Int
