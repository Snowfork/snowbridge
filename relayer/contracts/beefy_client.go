...
// SubmitFinal is a paid mutator transaction binding the contract method 0xe46493a0.
//
// Solidity: function submitFinal((uint32,uint64,(bytes32)) commitment, uint256[] bitfield, (uint8,bytes32,bytes32,uint256,address,bytes32[])[] proofs) returns()
...
// SubmitFinalWithHandover is a paid mutator transaction binding the contract method 0xad11825a.
//
// Solidity: function submitFinalWithHandover((uint32,uint64,(bytes32)) commitment, uint256[] bitfield, (uint8,bytes32,bytes32,uint256,address,bytes32[])[] proofs, (uint8,uint32,bytes32,uint64,uint32,bytes32,bytes32) leaf, bytes32[] leafProof, uint256 leafProofOrder) returns()
