...
//
// Solidity: function tickets(bytes32 ) view returns(address account, uint64 blockNumber, uint32 validatorSetLen, uint256 numRequiredSignatures, uint256 prevRandao, bytes32 bitfieldHash)
func (_BeefyClient *BeefyClientCaller) Tickets(opts *bind.CallOpts, arg0 [32]byte) (struct {
	Account               common.Address
	BlockNumber           uint64
	ValidatorSetLen       uint32
	NumRequiredSignatures *big.Int
	PrevRandao            *big.Int
	...
	outstruct.NumRequiredSignatures = *abi.ConvertType(out[3], new(*big.Int)).(**big.Int)
