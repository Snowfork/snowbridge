...
// SubmitInitial is a paid mutator transaction binding the contract method 0xf9ba5b13.
//
// Solidity: function submitInitial(bytes32 commitmentHash, uint256[] bitfield) payable returns()
func (_BeefyClient *BeefyClientTransactor) SubmitInitial(opts *bind.TransactOpts, commitmentHash [32]byte, bitfield []*big.Int) (*types.Transaction, error) {
	return _BeefyClient.contract.Transact(opts, "submitInitial", commitmentHash, bitfield)
}

// SubmitInitial is a paid mutator transaction binding the contract method 0xf9ba5b13.
//
// Solidity: function submitInitial(bytes32 commitmentHash, uint256[] bitfield) payable returns()
func (_BeefyClient *BeefyClientSession) SubmitInitial(commitmentHash [32]byte, bitfield []*big.Int) (*types.Transaction, error) {
	return _BeefyClient.Contract.SubmitInitial(&_BeefyClient.TransactOpts, commitmentHash, bitfield)
}

// SubmitInitial is a paid mutator transaction binding the contract method 0xf9ba5b13.
//
// Solidity: function submitInitial(bytes32 commitmentHash, uint256[] bitfield) payable returns()
func (_BeefyClient *BeefyClientTransactorSession) SubmitInitial(commitmentHash [32]byte, bitfield []*big.Int) (*types.Transaction, error) {
	return _BeefyClient.Contract.SubmitInitial(&_BeefyClient.TransactOpts, commitmentHash, bitfield)
}

// SubmitInitialWithHandover is a paid mutator transaction binding the contract method 0x0c76d7fa.
//
// Solidity: function submitInitialWithHandover(bytes32 commitmentHash, uint256[] bitfield) payable returns()
func (_BeefyClient *BeefyClientTransactor) SubmitInitialWithHandover(opts *bind.TransactOpts, commitmentHash [32]byte, bitfield []*big.Int) (*types.Transaction, error) {
	return _BeefyClient.contract.Transact(opts, "submitInitialWithHandover", commitmentHash, bitfield)
}

// SubmitInitialWithHandover is a paid mutator transaction binding the contract method 0x0c76d7fa.
//
// Solidity: function submitInitialWithHandover(bytes32 commitmentHash, uint256[] bitfield) payable returns()
func (_BeefyClient *BeefyClientSession) SubmitInitialWithHandover(commitmentHash [32]byte, bitfield []*big.Int) (*types.Transaction, error) {
	return _BeefyClient.Contract.SubmitInitialWithHandover(&_BeefyClient.TransactOpts, commitmentHash, bitfield)
}

// SubmitInitialWithHandover is a paid mutator transaction binding the contract method 0x0c76d7fa.
//
// Solidity: function submitInitialWithHandover(bytes32 commitmentHash, uint256[] bitfield) payable returns()
func (_BeefyClient *BeefyClientTransactorSession) SubmitInitialWithHandover(commitmentHash [32]byte, bitfield []*big.Int) (*types.Transaction, error) {
	return _BeefyClient.Contract.SubmitInitialWithHandover(&_BeefyClient.TransactOpts, commitmentHash, bitfield)
}
