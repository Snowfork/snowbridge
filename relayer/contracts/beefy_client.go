...
// SubmitInitial is a paid mutator transaction binding the contract method 0xb1890cd1.
//
// Solidity: function submitInitial((uint32,uint64,(bytes32,bytes,bytes)) commitment, uint256[] bitfield, (uint8,bytes32,bytes32,uint256,address,bytes32[]) proof) payable returns()
...
// SubmitInitialWithHandover is a paid mutator transaction binding the contract method 0xcea83492.
//
// Solidity: function submitInitialWithHandover((uint32,uint64,(bytes32,bytes,bytes)) commitment, uint256[] bitfield, (uint8,bytes32,bytes32,uint256,address,bytes32[]) proof) payable returns()
