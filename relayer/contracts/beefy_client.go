...
// MinimumSignatureSamples is a free data retrieval call binding the contract method 0xae4358c7.
//
// Solidity: function minimumSignatureSamples() view returns(uint256)
func (_BeefyClient *BeefyClientCaller) MinimumSignatureSamples(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _BeefyClient.contract.Call(opts, &out, "minimumSignatureSamples")
...
//
// Solidity: function minimumSignatureSamples() view returns(uint256)
func (_BeefyClient *BeefyClientSession) MinimumSignatureSamples() (*big.Int, error) {
	return _BeefyClient.Contract.MinimumSignatureSamples(&_BeefyClient.CallOpts)
}

// MinimumSignatureSamples is a free data retrieval call binding the contract method 0xae4358c7.
//
// Solidity: function minimumSignatureSamples() view returns(uint256)
func (_BeefyClient *BeefyClientCallerSession) MinimumSignatureSamples() (*big.Int, error) {
	return _BeefyClient.Contract.MinimumSignatureSamples(&_BeefyClient.CallOpts)
}
