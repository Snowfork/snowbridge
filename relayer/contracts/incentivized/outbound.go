...
//
// Solidity: function submit(address feePayer, bytes payload, uint64 _weight) returns()
func (_IncentivizedOutboundChannel *IncentivizedOutboundChannelTransactor) Submit(opts *bind.TransactOpts, feePayer common.Address, payload []byte, _weight uint64) (*types.Transaction, error) {
	return _IncentivizedOutboundChannel.contract.Transact(opts, "submit", feePayer, payload, _weight)
}

// Submit is a paid mutator transaction binding the contract method 0xadf12082.
//
// Solidity: function submit(address feePayer, bytes payload, uint64 _weight) returns()
func (_IncentivizedOutboundChannel *IncentivizedOutboundChannelSession) Submit(feePayer common.Address, payload []byte, _weight uint64) (*types.Transaction, error) {
	return _IncentivizedOutboundChannel.Contract.Submit(&_IncentivizedOutboundChannel.TransactOpts, feePayer, payload, _weight)
}

// Submit is a paid mutator transaction binding the contract method 0xadf12082.
//
// Solidity: function submit(address feePayer, bytes payload, uint64 _weight) returns()
func (_IncentivizedOutboundChannel *IncentivizedOutboundChannelTransactorSession) Submit(feePayer common.Address, payload []byte, _weight uint64) (*types.Transaction, error) {
	return _IncentivizedOutboundChannel.Contract.Submit(&_IncentivizedOutboundChannel.TransactOpts, feePayer, payload, _weight)
}
