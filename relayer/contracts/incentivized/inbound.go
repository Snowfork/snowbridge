...
// Submit is a paid mutator transaction binding the contract method 0x711badf4.
//
// Solidity: function submit((uint64,(uint64,address,uint128,bytes)[]) bundle, bytes proof) returns()
