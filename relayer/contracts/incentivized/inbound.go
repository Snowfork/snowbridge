...
// Submit is a paid mutator transaction binding the contract method 0x33b621e4.
//
// Solidity: function submit((uint64,uint128,(uint64,address,bytes)[]) bundle, bytes proof) returns()
