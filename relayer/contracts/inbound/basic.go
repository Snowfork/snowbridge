...
const BasicInboundChannelABI = "[{\"anonymous\":false,\"inputs\":[{\"indexed\":false,\"internalType\":\"uint64\",\"name\":\"nonce\",\"type\":\"uint64\"},{\"indexed\":false,\"internalType\":\"bool\",\"name\":\"result\",\"type\":\"bool\"}],\"name\":\"MessageDispatched\",\"type\":\"event\"},{\"inputs\":[],\"name\":\"MAX_GAS_PER_MESSAGE\",\"outputs\":[{\"internalType\":\"uint256\",\"name\":\"\",\"type\":\"uint256\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[],\"name\":\"nonce\",\"outputs\":[{\"internalType\":\"uint64\",\"name\":\"\",\"type\":\"uint64\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[{\"components\":[{\"internalType\":\"address\",\"name\":\"target\",\"type\":\"address\"},{\"internalType\":\"uint64\",\"name\":\"nonce\",\"type\":\"uint64\"},{\"internalType\":\"bytes\",\"name\":\"payload\",\"type\":\"bytes\"}],\"internalType\":\"structBasicInboundChannel.Message[]\",\"name\":\"_messages\",\"type\":\"tuple[]\"},{\"internalType\":\"bytes32\",\"name\":\"_commitment\",\"type\":\"bytes32\"}],\"name\":\"submit\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"}]"
...
func (_BasicInboundChannel *BasicInboundChannelTransactor) Submit(opts *bind.TransactOpts, _messages []BasicInboundChannelMessage, _commitment [32]byte) (*types.Transaction, error) {
	return _BasicInboundChannel.contract.Transact(opts, "submit", _messages, _commitment)
}

// Submit is a paid mutator transaction binding the contract method 0x6f8bfa34.
//
// Solidity: function submit((address,uint64,bytes)[] _messages, bytes32 _commitment) returns()
func (_BasicInboundChannel *BasicInboundChannelSession) Submit(_messages []BasicInboundChannelMessage, _commitment [32]byte) (*types.Transaction, error) {
	return _BasicInboundChannel.Contract.Submit(&_BasicInboundChannel.TransactOpts, _messages, _commitment)
}

// Submit is a paid mutator transaction binding the contract method 0x6f8bfa34.
//
// Solidity: function submit((address,uint64,bytes)[] _messages, bytes32 _commitment) returns()
func (_BasicInboundChannel *BasicInboundChannelTransactorSession) Submit(_messages []BasicInboundChannelMessage, _commitment [32]byte) (*types.Transaction, error) {
	return _BasicInboundChannel.Contract.Submit(&_BasicInboundChannel.TransactOpts, _messages, _commitment)
}
