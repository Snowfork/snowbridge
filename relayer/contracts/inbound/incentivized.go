...
// Submit is a paid mutator transaction binding the contract method 0x2f158aa3.
//
// Solidity: function submit((address,uint64,uint256,bytes)[] _messages, bytes32 _commitment) returns()
func (_IncentivizedInboundChannel *IncentivizedInboundChannelTransactor) Submit(opts *bind.TransactOpts, _messages []IncentivizedInboundChannelMessage, _commitment [32]byte) (*types.Transaction, error) {
	return _IncentivizedInboundChannel.contract.Transact(opts, "submit", _messages, _commitment)
}

// Submit is a paid mutator transaction binding the contract method 0x2f158aa3.
//
// Solidity: function submit((address,uint64,uint256,bytes)[] _messages, bytes32 _commitment) returns()
func (_IncentivizedInboundChannel *IncentivizedInboundChannelSession) Submit(_messages []IncentivizedInboundChannelMessage, _commitment [32]byte) (*types.Transaction, error) {
	return _IncentivizedInboundChannel.Contract.Submit(&_IncentivizedInboundChannel.TransactOpts, _messages, _commitment)
}

// Submit is a paid mutator transaction binding the contract method 0x2f158aa3.
//
// Solidity: function submit((address,uint64,uint256,bytes)[] _messages, bytes32 _commitment) returns()
func (_IncentivizedInboundChannel *IncentivizedInboundChannelTransactorSession) Submit(_messages []IncentivizedInboundChannelMessage, _commitment [32]byte) (*types.Transaction, error) {
	return _IncentivizedInboundChannel.Contract.Submit(&_IncentivizedInboundChannel.TransactOpts, _messages, _commitment)
}
