//go:generate bash -c "jq .abi ../../ethereum/artifacts/contracts/utils/OpaqueProof.sol/OpaqueProof.json | abigen --abi - --type OpaqueProof --pkg opaqueproof --out opaqueproof/contract.go"
...
//go:generate bash -c "jq .abi ../../ethereum/artifacts/contracts/BasicInboundChannelV2.sol/BasicInboundChannelV2.json | abigen --abi - --type BasicInboundChannelV2 --pkg basic --out basic/inboundv2.go"
