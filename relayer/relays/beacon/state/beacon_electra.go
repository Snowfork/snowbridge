...
type BeaconBlockBodyElectra struct {
	...
	ExecutionPayload      *ExecutionPayloadElectra      `json:"execution_payload"` // Modified in Electra
...
func (b *BeaconBlockElectra) ExecutionPayloadElectra() *ExecutionPayloadElectra {
