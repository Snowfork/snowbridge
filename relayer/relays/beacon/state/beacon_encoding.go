...
// Hash: 103dcc3fc6ea3b76d5d43adc7f003e25950dba76b1b48eae47046ca33a1f0e2e
// Version: 0.1.3-dev
package state
...
func (b *BeaconStateBellatrixMinimal) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (9) 'Eth1DataVotes'
	if size := len(b.Eth1DataVotes); size > 16 {
		err = ssz.ErrListTooBigFn("BeaconStateBellatrixMinimal.Eth1DataVotes", size, 16)
		return
	}
	for ii := 0; ii < len(b.Eth1DataVotes); ii++ {
		if dst, err = b.Eth1DataVotes[ii].MarshalSSZTo(dst); err != nil {
...
func (b *BeaconStateBellatrixMinimal) UnmarshalSSZ(buf []byte) error {
	...
	if err = b.CurrentSyncCommittee.UnmarshalSSZ(buf[7061:31685]); err != nil {
		return err
	}
	...
	if err = b.NextSyncCommittee.UnmarshalSSZ(buf[31685:56309]); err != nil {
		return err
	}

	// Offset (24) 'LatestExecutionPayloadHeader'
	if o24 = ssz.ReadOffset(buf[56309:56313]); o24 > size || o21 > o24 {
		return ssz.ErrOffset
	}
