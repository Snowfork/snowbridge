...
// Hash: 77b3146de7c0e53578572537bb2bca9583a72727058a19e5d89a3646076343ee
// Version: 0.1.3
package state
...
// MarshalSSZ ssz marshals the WithdrawalsRootContainer object
func (w *WithdrawalsRootContainer) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(w)
}

// MarshalSSZTo ssz marshals the WithdrawalsRootContainer object to a target array
func (w *WithdrawalsRootContainer) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf
	offset := int(4)
	...
	if size := len(w.Withdrawals); size > 16 {
		err = ssz.ErrListTooBigFn("WithdrawalsRootContainer.Withdrawals", size, 16)
		return
	}
...
// UnmarshalSSZ ssz unmarshals the WithdrawalsRootContainer object
func (w *WithdrawalsRootContainer) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size < 4 {
		return ssz.ErrSize
...
// SizeSSZ returns the ssz encoded size in bytes for the WithdrawalsRootContainer object
func (w *WithdrawalsRootContainer) SizeSSZ() (size int) {
	size = 4
...
// HashTreeRoot ssz hashes the WithdrawalsRootContainer object
func (w *WithdrawalsRootContainer) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(w)
}

// HashTreeRootWith ssz hashes the WithdrawalsRootContainer object with a hasher
func (w *WithdrawalsRootContainer) HashTreeRootWith(hh ssz.HashWalker) (err error) {
	indx := hh.Index()
...
// GetTree ssz hashes the WithdrawalsRootContainer object
func (w *WithdrawalsRootContainer) GetTree() (*ssz.Node, error) {
	return ssz.ProofTree(w)
}
