...
mod tests {
	...
	const RAW_DATA: &'static str = concat!(
	...
	#[test]
	fn decode_log() {
		let bytes: Vec<u8> = RAW_DATA.from_hex().unwrap();
		let log: Log = rlp::decode(&bytes).unwrap();
		assert_eq!(log.address.as_bytes().to_hex::<String>(), "1cfd66659d44cfe2e627c5742ba7477a3284cffa");
		assert_eq!(log.topics[0].as_bytes().to_hex::<String>(), "266413be5700ce8dd5ac6b9a7dfbabe99b3e45cae9a68ac2757858710b401a38");
	}
