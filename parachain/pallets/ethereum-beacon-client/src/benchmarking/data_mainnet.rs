...
use hex_literal::hex;
use snowbridge_beacon_primitives::{Attestation, AttestationData, BeaconBlock, BeaconHeader, BlockUpdate, Body, Checkpoint, Eth1Data, ExecutionPayload, FinalizedHeaderUpdate, HeaderUpdate, InitialSync, PublicKey, SyncAggregate, SyncCommittee, SyncCommitteePeriodUpdate};
use sp_core::U256;
use sp_std::vec;
...
> {
	return HeaderUpdate{
        beacon_header: BeaconHeader {
            ...
            body_root: hex!("2418bf9dd1859886a93439d2ef259b2538aac3298bd2572b51ed554df34a33a0").into(),
        },
        ...
        block_root_branch_header_root: hex!("f69f1d00c35ab4e84159eb4aa3446ef8aa056ef518f5c0ff8a965ae7d486eabd").into(),
    };
}
