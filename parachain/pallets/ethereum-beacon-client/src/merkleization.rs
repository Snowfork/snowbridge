...
>(
	...
	>,
) -> Result<SSZBeaconBlockBody, MerkleizationError> {
...
pub fn get_ssz_attestation<AttestionBitsSize: Get<u32>, SignatureSize: Get<u32>>(
	attestation: Attestation<AttestionBitsSize, SignatureSize>,
) -> Result<SSZAttestation, MerkleizationError> {
...
pub fn get_ssz_attestation_data(
	attestation_data: AttestationData,
) -> Result<SSZAttestationData, MerkleizationError> {
...
pub fn get_ssz_attester_slashing<AttestingIndicesSize: Get<u32>, SignatureSize: Get<u32>>(
	attester_slashing: AttesterSlashing<AttestingIndicesSize, SignatureSize>,
) -> Result<SSZAttesterSlashing, MerkleizationError> {
...
) -> Result<SSZBeaconBlockHeader, MerkleizationError> {
...
pub fn get_ssz_sync_aggregate<SyncCommitteeBitsSize: Get<u32>, SignatureSize: Get<u32>>(
	sync_aggregate: SyncAggregate<SyncCommitteeBitsSize, SignatureSize>,
) -> Result<SSZSyncAggregate, MerkleizationError> {
	Ok(SSZSyncAggregate {
