use crate::config::{
	MAX_EXTRA_DATA_BYTES, MAX_FEE_RECIPIENT_SIZE, MAX_LOGS_BLOOM_SIZE, PUBKEY_SIZE, SIGNATURE_SIZE,
	SYNC_COMMITTEE_SIZE,
};
...
pub struct SSZExecutionPayloadHeader {
	...
	pub fee_recipient: Vector<u8, MAX_FEE_RECIPIENT_SIZE>,
	pub state_root: [u8; 32],
	pub receipts_root: [u8; 32],
	pub logs_bloom: Vector<u8, MAX_LOGS_BLOOM_SIZE>,
