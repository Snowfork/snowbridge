...
//! DATE: 2022-09-20, STEPS: `10`, REPEAT: 10, LOW RANGE: `[]`, HIGH RANGE: `[]`
...
pub trait WeightInfo {	fn sync_committee_period_update() -> Weight;}
...
impl<T: frame_system::Config> WeightInfo for SnowbridgeWeight<T> {	fn sync_committee_period_update() -> Weight {
		(48_664_106_000 as Weight)			.saturating_add(T::DbWeight::get().reads(4 as Weight))			.saturating_add(T::DbWeight::get().writes(3 as Weight))	}}

// For backwards compatibility and tests
impl WeightInfo for () {	fn sync_committee_period_update() -> Weight {
		(48_664_106_000 as Weight)			.saturating_add(RocksDbWeight::get().reads(4 as Weight))			.saturating_add(RocksDbWeight::get().writes(3 as Weight))	}}
