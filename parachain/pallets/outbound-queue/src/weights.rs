...
//! Autogenerated weights for `snowbridge_outbound_queue_pallet`
//!
...
// --pallet=snowbridge_outbound_queue_pallet
// --extrinsic=*
// --execution=wasm
...
/// Weight functions needed for `snowbridge_outbound_queue_pallet`.
