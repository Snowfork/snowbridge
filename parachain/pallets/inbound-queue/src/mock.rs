...
frame_support::construct_runtime!(
	pub enum Test
	{
		...
		EthereumBeaconClient: snowbridge_ethereum_client_pallet::{Pallet, Call, Storage, Event<T>},
...
impl snowbridge_ethereum_client_pallet::Config for Test {
	type RuntimeEvent = RuntimeEvent;
...
impl<T: snowbridge_ethereum_client_pallet::Config> BenchmarkHelper<T> for Test {
