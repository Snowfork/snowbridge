...
use polkadot_runtime_common::{BlockHashCount, SlowAdjustingFeeUpdate, ToAuthor};
...
parameter_types! {
	...
	pub PreimageBaseDeposit: Balance = crate::currency::deposit(2, 64);
	pub PreimageByteDeposit: Balance = crate::currency::deposit(0, 1);
}
