...
//! EXECUTION: Some(Wasm), WASM-EXECUTION: Compiled, CHAIN: Some("/tmp/artemis-benchmark-Cw7/spec.json"), DB CACHE: 128

// Executed Command:
// target/release/artemis
// benchmark
// --chain
// /tmp/artemis-benchmark-Cw7/spec.json
// --execution
// wasm
// --wasm-execution
// compiled
...
impl<T: frame_system::Config> incentivized_channel::outbound::WeightInfo for WeightInfo<T> {
	fn on_initialize(m: u32, ) -> Weight {
		(31_284_000 as Weight)
			// Standard Error: 24_000
			.saturating_add((13_530_000 as Weight).saturating_mul(m as Weight))
